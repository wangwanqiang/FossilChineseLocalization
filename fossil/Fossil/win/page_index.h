...
extern void re_rules_page(void);
...
extern void robot_restrict_test_page(void);
...
extern void test_generate_uuid(void);
...
static const CmdOrPage aCommand[] = {
  { "/.well-known",             wellknown_page,               zHelp324, 324, 0x008 },
  { "/access_log",              user_log_page,                zHelp585, 585, 0x008 },
  { "/admin_log",               page_admin_log,               zHelp475, 475, 0x008 },
  { "/admin_sql",               sql_page,                     zHelp473, 473, 0x008 },
  { "/admin_th1",               th1_page,                     zHelp474, 474, 0x008 },
  { "/ainfo",                   ainfo_page,                   zHelp039,  39, 0x008 },
  { "/ajax",                    ajax_route_dispatcher,        zHelp008,   8, 0x808 },
  { "/alerts",                  alert_page,                   zHelp024,  24, 0x008 },
  { "/ambiguous",               ambiguous_page,               zHelp393, 393, 0x008 },
  { "/annotate",                annotation_page,              zHelp238, 238, 0x008 },
  { "/announce",                announce_page,                zHelp032,  32, 0x008 },
  { "/artifact",                artifact_page,                zHelp340, 340, 0x008 },
  { "/artifact_stats",          artifact_stats_page,          zHelp510, 510, 0x008 },
  ...
  { "/background",              background_page,              zHelp259, 259, 0x008 },
  { "/bigbloblist",             bigbloblist_page,             zHelp400, 400, 0x008 },
  { "/blame",                   annotation_page,              zHelp238, 238, 0x008 },
  { "/bloblist",                bloblist_page,                zHelp398, 398, 0x008 },
  ...
  { "/captcha-audio",           captcha_wav_page,             zHelp080,  80, 0x008 },
  { "/chat",                    chat_webpage,                 zHelp090,  90, 0x1008 },
  { "/chat-backup",             chat_backup_webpage,          zHelp098,  98, 0x808 },
  { "/chat-delete",             chat_delete_webpage,          zHelp097,  97, 0x1808 },
  { "/chat-download",           chat_download_webpage,        zHelp096,  96, 0x1808 },
  { "/chat-fetch-one",          chat_fetch_one,               zHelp095,  95, 0x1808 },
  { "/chat-poll",               chat_poll_webpage,            zHelp093,  93, 0x1808 },
  { "/chat-query",              chat_query_webpage,           zHelp094,  94, 0x1808 },
  { "/chat-send",               chat_send_webpage,            zHelp091,  91, 0x1808 },
  { "/ci",                      ci_page,                      zHelp329, 329, 0x008 },
  { "/ci_edit",                 ci_edit_page,                 zHelp346, 346, 0x008 },
  { "/ci_tags",                 ci_tags_page,                 zHelp327, 327, 0x008 },
  { "/ckout",                   ckout_page,                   zHelp328, 328, 0x008 },
  { "/clusterlist",             clusterlist_page,             zHelp406, 406, 0x008 },
  { "/contact_admin",           contact_admin_page,           zHelp031,  31, 0x008 },
  { "/cookies",                 cookie_page,                  zHelp135, 135, 0x008 },
  { "/debug_tktedit",           tktedit_page,                 zHelp552, 552, 0x008 },
  { "/debug_tktnew",            tktnew_page,                  zHelp550, 550, 0x008 },
  { "/deltachain",              deltachain_page,              zHelp401, 401, 0x008 },
  { "/dir",                     page_dir,                     zHelp061,  61, 0x008 },
  { "/doc",                     doc_page,                     zHelp256, 256, 0x008 },
  { "/docdir",                  page_docdir,                  zHelp060,  60, 0x008 },
  { "/docfile",                 artifact_page,                zHelp340, 340, 0x008 },
  { "/docsrch",                 doc_search_page,              zHelp261, 261, 0x008 },
  { "/download",                download_page,                zHelp115, 115, 0x008 },
  { "/errorlog",                errorlog_page,                zHelp457, 457, 0x008 },
  { "/event",                   event_page,                   zHelp266, 266, 0x008 },
  { "/eventedit",               eventedit_page,               zHelp268, 268, 0x008 },
  { "/ext",                     ext_page,                     zHelp274, 274, 0x208 },
  { "/extfilelist",             ext_filelist_page,            zHelp275, 275, 0x008 },
  { "/favicon.ico",             favicon_page,                 zHelp260, 260, 0x008 },
  { "/fdiff",                   diff_page,                    zHelp334, 334, 0x008 },
  { "/fdscookie",               cookie_page,                  zHelp135, 135, 0x008 },
  { "/file",                    artifact_page,                zHelp340, 340, 0x008 },
  { "/fileage",                 fileage_page,                 zHelp064,  64, 0x008 },
  { "/fileedit",                fileedit_page,                zHelp292, 292, 0x008 },
  { "/finfo",                   finfo_page,                   zHelp295, 295, 0x008 },
  { "/forum",                   forum_main_page,              zHelp310, 310, 0x008 },
  { "/forume1",                 forumnew_page,                zHelp305, 305, 0x008 },
  { "/forume2",                 forumedit_page,               zHelp306, 306, 0x008 },
  { "/forumedit",               forum_page_init,              zHelp303, 303, 0x008 },
  { "/forummain",               forum_main_page,              zHelp310, 310, 0x008 },
  { "/forumnew",                forum_page_init,              zHelp303, 303, 0x008 },
  { "/forumpost",               forumpost_page,               zHelp299, 299, 0x008 },
  { "/forumpost_close",         forum_page_close,             zHelp301, 301, 0x808 },
  { "/forumpost_reopen",        forum_page_close,             zHelp301, 301, 0x808 },
  { "/forumthread",             forumthread_page,             zHelp300, 300, 0x008 },
  { "/forumthreadhashlist",     forumthreadhashlist,          zHelp298, 298, 0x008 },
  { "/hash-collisions",         hash_collisions_webpage,      zHelp405, 405, 0x008 },
  { "/hash-color-test",         test_hash_color_page,         zHelp119, 119, 0x008 },
  { "/help",                    help_page,                    zHelp250, 250, 0x008 },
  { "/hexdump",                 hexdump_page,                 zHelp338, 338, 0x008 },
  { "/home",                    home_page,                    zHelp593, 593, 0x008 },
  { "/honeypot",                honeypot_page,                zHelp078,  78, 0x008 },
  { "/index",                   home_page,                    zHelp593, 593, 0x008 },
  { "/info",                    info_page,                    zHelp345, 345, 0x008 },
  { "/intermap",                interwiki_page,               zHelp351, 351, 0x008 },
  { "/ityaar",                  captcha_callback,             zHelp079,  79, 0x008 },
  { "/jchunk",                  jchunk_page,                  zHelp337, 337, 0x808 },
#ifdef FOSSIL_ENABLE_JSON
  { "/json",                    json_page_top,                zHelp352, 352, 0x008 },
#endif
  { "/juvlist",                 uvlist_json_page,             zHelp575, 575, 0x008 },
  { "/leaves",                  leaves_page,                  zHelp232, 232, 0x008 },
  { "/login",                   login_page,                   zHelp359, 359, 0x008 },
  { "/logo",                    logo_page,                    zHelp258, 258, 0x008 },
  { "/logout",                  login_page,                   zHelp359, 359, 0x008 },
  { "/markup_help",             markup_help_page,             zHelp598, 598, 0x008 },
  { "/md_rules",                markdown_rules_page,          zHelp596, 596, 0x008 },
  { "/mimetype_list",           mimetype_list_page,           zHelp255, 255, 0x008 },
  { "/mlink",                   mlink_page,                   zHelp296, 296, 0x008 },
  { "/modreq",                  modreq_page,                  zHelp391, 391, 0x008 },
  { "/my",                      login_page,                   zHelp359, 359, 0x008 },
  { "/not_found",               home_page,                    zHelp593, 593, 0x008 },
  { "/oneclickunsub",           unsubscribe_page,             zHelp026,  26, 0x008 },
  { "/phantoms",                phantom_list_page,            zHelp399, 399, 0x008 },
  { "/pikchrshow",              pikchrshow_page,              zHelp413, 413, 0x008 },
  { "/praise",                  annotation_page,              zHelp238, 238, 0x008 },
  { "/raw",                     rawartifact_page,             zHelp335, 335, 0x008 },
  { "/rcvfrom",                 rcvfrom_page,                 zHelp488, 488, 0x008 },
  { "/rcvfromlist",             rcvfromlist_page,             zHelp487, 487, 0x008 },
  { "/re_rules",                re_rules_page,                zHelp434, 434, 0x008 },
  { "/register",                register_page,                zHelp365, 365, 0x008 },
  { "/renew",                   renewal_page,                 zHelp025,  25, 0x008 },
  { "/repo-tabsize",            repo_tabsize_page,            zHelp509, 509, 0x008 },
  { "/repo_schema",             repo_schema_page,             zHelp507, 507, 0x008 },
  { "/repo_stat1",              repo_stat1_page,              zHelp508, 508, 0x008 },
  { "/reportlist",              view_list,                    zHelp437, 437, 0x008 },
  { "/reports",                 stats_report_page,            zHelp511, 511, 0x008 },
  { "/reqpwreset",              login_reqpwreset_page,        zHelp366, 366, 0x008 },
  { "/resetpw",                 login_resetpw,                zHelp363, 363, 0x008 },
  { "/robots.txt",              robotstxt_page,               zHelp519, 519, 0x008 },
  { "/rptedit",                 view_edit,                    zHelp439, 439, 0x008 },
  { "/rptnew",                  view_edit,                    zHelp439, 439, 0x008 },
  { "/rptsql",                  view_see_sql,                 zHelp438, 438, 0x008 },
  { "/rptview",                 rptview_page,                 zHelp441, 441, 0x008 },
  { "/script.js",               page_script_js,               zHelp513, 513, 0x008 },
  { "/search",                  search_page,                  zHelp450, 450, 0x008 },
  { "/secaudit0",               secaudit0_page,               zHelp455, 455, 0x008 },
  { "/secureraw",               secure_rawartifact_page,      zHelp336, 336, 0x008 },
#if USE_SEE
  { "/setseekey",               db_set_see_key_page,          zHelp140, 140, 0x008 },
#endif
  { "/setup",                   setup_page,                   zHelp458, 458, 0x008 },
  { "/setup-logmenu",           setup_logmenu_page,           zHelp459, 459, 0x008 },
  { "/setup_access",            setup_access,                 zHelp461, 461, 0x008 },
  { "/setup_adunit",            setup_adunit,                 zHelp471, 471, 0x008 },
  { "/setup_chat",              setup_chat,                   zHelp469, 469, 0x008 },
  { "/setup_config",            setup_config,                 zHelp467, 467, 0x008 },
  { "/setup_forum",             forum_setup,                  zHelp309, 309, 0x008 },
  { "/setup_login_group",       setup_login_group,            zHelp462, 462, 0x008 },
  { "/setup_logo",              setup_logo,                   zHelp472, 472, 0x008 },
  { "/setup_modreq",            setup_modreq,                 zHelp470, 470, 0x008 },
  { "/setup_notification",      setup_notification,           zHelp009,   9, 0x008 },
  { "/setup_robot",             setup_robots,                 zHelp460, 460, 0x008 },
  { "/setup_settings",          setup_settings,               zHelp464, 464, 0x008 },
  { "/setup_skin",              setup_skin,                   zHelp495, 495, 0x008 },
  { "/setup_skin_admin",        setup_skin_admin,             zHelp493, 493, 0x008 },
  { "/setup_skinedit",          setup_skinedit,               zHelp494, 494, 0x008 },
  { "/setup_timeline",          setup_timeline,               zHelp463, 463, 0x008 },
  { "/setup_ucap_list",         setup_ucap_list,              zHelp480, 480, 0x008 },
  { "/setup_uedit",             user_edit,                    zHelp482, 482, 0x008 },
  { "/setup_uinfo",             setup_uinfo_page,             zHelp483, 483, 0x008 },
  { "/setup_ulist",             setup_ulist,                  zHelp478, 478, 0x008 },
  { "/setup_ulist_notes",       setup_ulist_notes,            zHelp479, 479, 0x008 },
  { "/setup_wiki",              setup_wiki,                   zHelp468, 468, 0x008 },
  { "/shun",                    shun_page,                    zHelp486, 486, 0x008 },
  { "/sitemap",                 sitemap_page,                 zHelp489, 489, 0x008 },
  { "/sitemap-test",            sitemap_test_page,            zHelp490, 490, 0x008 },
  { "/sitemap-timeline",        sitemap_timeline_page,        zHelp491, 491, 0x008 },
  { "/skins",                   skins_page,                   zHelp496, 496, 0x008 },
  { "/sqlar",                   baseline_zip_page,            zHelp629, 629, 0x008 },
  { "/srchsetup",               page_srchsetup,               zHelp476, 476, 0x008 },
  { "/stat",                    stat_page,                    zHelp504, 504, 0x008 },
  { "/style.css",               page_style_css,               zHelp514, 514, 0x1008 },
  { "/subscribe",               subscribe_page,               zHelp023,  23, 0x008 },
  { "/subscribers",             subscriber_list_page,         zHelp028,  28, 0x008 },
  { "/taglist",                 taglist_page,                 zHelp529, 529, 0x008 },
  { "/tagtimeline",             tagtimeline_page,             zHelp530, 530, 0x008 },
  { "/takeitprivate",           takeitprivate_page,           zHelp456, 456, 0x008 },
  { "/tarball",                 tarball_page,                 zHelp533, 533, 0x008 },
  { "/technote",                event_page,                   zHelp266, 266, 0x008 },
  { "/technoteedit",            eventedit_page,               zHelp268, 268, 0x008 },
  { "/test-all-help",           test_all_help_page,           zHelp251, 251, 0x008 },
  { "/test-backlink-timeline",  backlink_timeline_page,       zHelp042,  42, 0x008 },
  { "/test-backlinks",          backlink_table_page,          zHelp043,  43, 0x008 },
  { "/test-bgcolor",            test_bgcolor_page,            zHelp120, 120, 0x008 },
  { "/test-builtin-files",      test_builtin_list_page,       zHelp066,  66, 0x008 },
  { "/test-captcha",            captcha_test,                 zHelp077,  77, 0x008 },
  { "/test-captcha-audio",      captcha_test_wav_page,        zHelp081,  81, 0x008 },
  { "/test-env",                page_test_env,                zHelp516, 516, 0x008 },
  { "/test-ftsdocs",            search_data_page,             zHelp454, 454, 0x008 },
  { "/test-overload",           overload_page,                zHelp356, 356, 0x008 },
  { "/test-pid",                test_pid_page,                zHelp373, 373, 0x008 },
  { "/test-piechart",           piechart_test_page,           zHelp412, 412, 0x008 },
  { "/test-rename-list",        test_rename_list_page,        zHelp411, 411, 0x008 },
  { "/test-robotck",            robot_restrict_test_page,     zHelp444, 444, 0x008 },
  { "/test-title",              page_test_title,              zHelp515, 515, 0x008 },
  { "/test-warning",            test_warning_page,            zHelp379, 379, 0x008 },
  { "/test_env",                page_test_env,                zHelp516, 516, 0x2008 },
  { "/thisdayinhistory",        thisdayinhistory_page,        zHelp545, 545, 0x008 },
  { "/ticket",                  tkt_home_page,                zHelp557, 557, 0x008 },
  { "/timeline",                page_timeline,                zHelp543, 543, 0x008 },
  { "/timeline.rss",            page_timeline_rss,            zHelp446, 446, 0x008 },
  { "/timewarps",               test_timewarp_page,           zHelp547, 547, 0x008 },
  { "/tinfo",                   tinfo_page,                   zHelp344, 344, 0x008 },
  { "/tktedit",                 tktedit_page,                 zHelp552, 552, 0x008 },
  { "/tkthistory",              tkthistory_page,              zHelp555, 555, 0x008 },
  { "/tktnew",                  tktnew_page,                  zHelp550, 550, 0x008 },
  { "/tktsetup",                tktsetup_page,                zHelp559, 559, 0x008 },
  { "/tktsetup_change",         tktsetup_change_page,         zHelp562, 562, 0x008 },
  { "/tktsetup_com",            tktsetup_com_page,            zHelp561, 561, 0x008 },
  { "/tktsetup_editpage",       tktsetup_editpage_page,       zHelp565, 565, 0x008 },
  { "/tktsetup_keytplt",        tktsetup_keytplt_page,        zHelp568, 568, 0x008 },
  { "/tktsetup_newpage",        tktsetup_newpage_page,        zHelp563, 563, 0x008 },
  { "/tktsetup_reportlist",     tktsetup_reportlist,          zHelp566, 566, 0x008 },
  { "/tktsetup_rpttplt",        tktsetup_rpttplt_page,        zHelp567, 567, 0x008 },
  { "/tktsetup_tab",            tktsetup_tab_page,            zHelp560, 560, 0x008 },
  { "/tktsetup_timeline",       tktsetup_timeline_page,       zHelp569, 569, 0x008 },
  { "/tktsetup_viewpage",       tktsetup_viewpage_page,       zHelp564, 564, 0x008 },
  { "/tktsrch",                 tkt_srchpage,                 zHelp558, 558, 0x008 },
  { "/tkttimeline",             tkttimeline_page,             zHelp554, 554, 0x008 },
  { "/tktview",                 tktview_page,                 zHelp549, 549, 0x008 },
  { "/tokens",                  tokens_page,                  zHelp445, 445, 0x008 },
  { "/tree",                    page_tree,                    zHelp062,  62, 0x008 },
#if USE_SEE
  { "/unsetseekey",             db_unset_see_key_page,        zHelp141, 141, 0x008 },
#endif
  { "/unsubscribe",             unsubscribe_page,             zHelp026,  26, 0x008 },
  { "/urllist",                 urllist_page,                 zHelp506, 506, 0x008 },
  { "/user_log",                user_log_page,                zHelp585, 585, 0x008 },
  { "/uv",                      doc_page,                     zHelp256, 256, 0x008 },
  { "/uvlist",                  uvlist_page,                  zHelp574, 574, 0x008 },
  { "/vdiff",                   vdiff_page,                   zHelp332, 332, 0x008 },
  { "/version",                 test_version_page,            zHelp371, 371, 0x008 },
  { "/vinfo",                   ci_page,                      zHelp329, 329, 0x008 },
  { "/vpatch",                  vpatch_page,                  zHelp246, 246, 0x008 },
  { "/waliassetup",             page_waliassetup,             zHelp477, 477, 0x008 },
  { "/wcontent",                wcontent_page,                zHelp608, 608, 0x008 },
  { "/wdiff",                   wdiff_page,                   zHelp607, 607, 0x008 },
  { "/wfind",                   wfind_page,                   zHelp609, 609, 0x008 },
  { "/whatis",                  artifact_page,                zHelp340, 340, 0x008 },
  { "/whistory",                whistory_page,                zHelp606, 606, 0x008 },
  { "/wiki",                    wiki_page,                    zHelp601, 601, 0x008 },
  { "/wiki_rules",              wiki_rules_page,              zHelp597, 597, 0x008 },
  { "/wikiajax",                wiki_ajax_page,               zHelp602, 602, 0x808 },
  { "/wikiappend",              wikiappend_page,              zHelp605, 605, 0x008 },
  { "/wikiedit",                wikiedit_page,                zHelp603, 603, 0x008 },
  { "/wikihelp",                wiki_helppage,                zHelp599, 599, 0x008 },
  { "/wikinew",                 wikinew_page,                 zHelp604, 604, 0x008 },
  { "/wikisrch",                wiki_srchpage,                zHelp600, 600, 0x008 },
  { "/winfo",                   winfo_page,                   zHelp331, 331, 0x008 },
  { "/xfer",                    page_xfer,                    zHelp619, 619, 0x1208 },
  { "/xfersetup",               xfersetup_page,               zHelp621, 621, 0x008 },
  { "/xfersetup_com",           xfersetup_com_page,           zHelp622, 622, 0x008 },
  { "/xfersetup_commit",        xfersetup_commit_page,        zHelp624, 624, 0x008 },
  { "/xfersetup_push",          xfersetup_push_page,          zHelp623, 623, 0x008 },
  { "/xfersetup_ticket",        xfersetup_ticket_page,        zHelp625, 625, 0x008 },
  { "/zip",                     baseline_zip_page,            zHelp629, 629, 0x008 },
  { "3-way-merge",              merge_3way_cmd,               zHelp390, 390, 0x012 },
  { "access-log",               0,                            zHelp148, 148, 0x120 },
  { "add",                      add_cmd,                      zHelp001,   1, 0x011 },
  { "addremove",                addremove_cmd,                zHelp005,   5, 0x011 },
  { "admin-log",                0,                            zHelp149, 149, 0x120 },
  { "alerts",                   alert_cmd,                    zHelp022,  22, 0x8012 },
  { "all",                      all_cmd,                      zHelp033,  33, 0x8011 },
  { "allow-symlinks",           0,                            zHelp150, 150, 0x520 },
  { "amend",                    ci_amend_cmd,                 zHelp347, 347, 0x011 },
  { "annotate",                 annotate_cmd,                 zHelp241, 241, 0x011 },
  { "anon-cookie-lifespan",     0,                            zHelp357, 357, 0x020 },
  { "artifact",                 artifact_cmd,                 zHelp126, 126, 0x012 },
  { "attachment",               attachment_cmd,               zHelp040,  40, 0x012 },
  { "auto-captcha",             0,                            zHelp151, 151, 0x120 },
  { "auto-hyperlink",           0,                            zHelp152, 152, 0x020 },
  { "auto-hyperlink-delay",     0,                            zHelp153, 153, 0x020 },
  { "auto-hyperlink-mouseover", 0,                            zHelp154, 154, 0x120 },
  { "auto-shun",                0,                            zHelp155, 155, 0x120 },
  { "autosync",                 0,                            zHelp156, 156, 0x020 },
  { "autosync-tries",           0,                            zHelp157, 157, 0x020 },
  { "backoffice",               backoffice_command,           zHelp048,  48, 0x012 },
  { "backoffice-disable",       0,                            zHelp159, 159, 0x120 },
  { "backoffice-logfile",       0,                            zHelp160, 160, 0x420 },
  { "backoffice-nodelay",       0,                            zHelp158, 158, 0x120 },
  { "backup",                   backup_cmd,                   zHelp525, 525, 0x012 },
  { "binary-glob",              0,                            zHelp161, 161, 0x0e0 },
  { "bisect",                   bisect_cmd,                   zHelp049,  49, 0x011 },
  { "blame",                    annotate_cmd,                 zHelp241, 241, 0x011 },
...
#endif
#if !(defined(_WIN32)||defined(__CYGWIN__)||defined(__DARWIN__))
  { "case-sensitive",           0,                            zHelp163, 163, 0x120 },
#endif
  { "cat",                      cat_cmd,                      zHelp294, 294, 0x011 },
  { "cgi",                      cmd_cgi,                      zHelp372, 372, 0x012 },
  { "changes",                  status_cmd,                   zHelp100, 100, 0x011 },
  { "chat",                     chat_command,                 zHelp099,  99, 0x011 },
  { "chat-alert-sound",         0,                            zHelp088,  88, 0x020 },
  { "chat-initial-history",     0,                            zHelp083,  83, 0x020 },
  { "chat-inline-images",       0,                            zHelp086,  86, 0x120 },
  { "chat-keep-count",          0,                            zHelp084,  84, 0x020 },
  { "chat-keep-days",           0,                            zHelp085,  85, 0x020 },
  { "chat-poll-timeout",        0,                            zHelp087,  87, 0x020 },
  { "chat-timeline-user",       0,                            zHelp089,  89, 0x020 },
  { "checkout",                 checkout_cmd,                 zHelp111, 111, 0x012 },
  { "cherry-pick",              merge_cmd,                    zHelp387, 387, 0x2010 },
  { "cherrypick",               merge_cmd,                    zHelp387, 387, 0x011 },
  { "ci",                       commit_cmd,                   zHelp109, 109, 0x2010 },
  { "clean",                    clean_cmd,                    zHelp105, 105, 0x011 },
  { "clean-glob",               0,                            zHelp164, 164, 0x0e0 },
  { "clearsign",                0,                            zHelp165, 165, 0x120 },
  { "clone",                    clone_cmd,                    zHelp114, 114, 0x011 },
  { "close",                    close_cmd,                    zHelp113, 113, 0x012 },
  { "co",                       checkout_cmd,                 zHelp111, 111, 0x2010 },
  { "comment-format",           0,                            zHelp166, 166, 0x020 },
  { "commit",                   commit_cmd,                   zHelp109, 109, 0x011 },
  { "configuration",            configuration_cmd,            zHelp122, 122, 0x012 },
  { "crlf-glob",                0,                            zHelp167, 167, 0x0e0 },
  { "crnl-glob",                0,                            zHelp168, 168, 0x0e0 },
  { "dbstat",                   dbstat_cmd,                   zHelp505, 505, 0x011 },
  { "deconstruct",              deconstruct_cmd,              zHelp430, 430, 0x012 },
  { "default-csp",              0,                            zHelp216, 216, 0x40a0 },
  { "default-perms",            0,                            zHelp169, 169, 0x4420 },
  { "default-skin",             0,                            zHelp492, 492, 0x020 },
  { "delete",                   delete_cmd,                   zHelp002,   2, 0x011 },
  { "descendants",              descendants_cmd,              zHelp230, 230, 0x012 },
  { "describe",                 describe_cmd,                 zHelp349, 349, 0x011 },
  { "detach",                   test_detach_cmd,              zHelp424, 424, 0x012 },
  { "diff",                     diff_cmd,                     zHelp244, 244, 0x011 },
  { "diff-binary",              0,                            zHelp170, 170, 0x120 },
  { "diff-command",             0,                            zHelp171, 171, 0x420 },
  { "dont-commit",              0,                            zHelp172, 172, 0x120 },
  { "dont-push",                0,                            zHelp173, 173, 0x120 },
  { "dotfiles",                 0,                            zHelp174, 174, 0x160 },
  { "editor",                   0,                            zHelp175, 175, 0x420 },
  ...
  { "empty-dirs",               0,                            zHelp176, 176, 0x0e0 },
  { "encoding-glob",            0,                            zHelp177, 177, 0x0e0 },
#if !defined(FOSSIL_ENABLE_EXEC_REL_PATHS)
  { "exec-rel-paths",           0,                            zHelp179, 179, 0x120 },
#endif
#if defined(FOSSIL_ENABLE_EXEC_REL_PATHS)
  { "exec-rel-paths",           0,                            zHelp178, 178, 0x120 },
#endif
  { "export",                   export_cmd,                   zHelp270, 270, 0x012 },
  { "extras",                   extras_cmd,                   zHelp104, 104, 0x011 },
  { "fdiff",                    fdiff_cmd,                    zHelp237, 237, 0x011 },
  { "fileedit-glob",            0,                            zHelp180, 180, 0x0a0 },
  { "finfo",                    finfo_cmd,                    zHelp293, 293, 0x011 },
  { "forbid-delta-manifests",   0,                            zHelp181, 181, 0x120 },
  { "forget",                   delete_cmd,                   zHelp002,   2, 0x012 },
  { "forum-close-policy",       0,                            zHelp307, 307, 0x120 },
  { "forum-title",              0,                            zHelp308, 308, 0x020 },
  { "fts-config",               fts_config_cmd,               zHelp453, 453, 0x8012 },
  { "fusefs",                   fusefs_cmd,                   zHelp313, 313, 0x012 },
  { "gdiff",                    diff_cmd,                     zHelp244, 244, 0x011 },
  { "gdiff-command",            0,                            zHelp182, 182, 0x420 },
  { "git",                      gitmirror_command,            zHelp273, 273, 0x012 },
  { "gmerge-command",           0,                            zHelp183, 183, 0x420 },
  { "grep",                     re_grep_cmd,                  zHelp433, 433, 0x011 },
  { "hash-digits",              0,                            zHelp184, 184, 0x020 },
  { "hash-policy",              hash_policy_command,          zHelp317, 317, 0x012 },
  { "help",                     help_cmd,                     zHelp253, 253, 0x011 },
  { "hook",                     hook_cmd,                     zHelp319, 319, 0x012 },
  { "hooks",                    0,                            zHelp318, 318, 0x4a0 },
  { "http",                     cmd_http,                     zHelp374, 374, 0x012 },
  { "http-port",                0,                            zHelp185, 185, 0x020 },
  { "https-login",              0,                            zHelp186, 186, 0x120 },
  { "ignore-glob",              0,                            zHelp187, 187, 0x0e0 },
  { "import",                   import_cmd,                   zHelp325, 325, 0x012 },
  { "info",                     info_cmd,                     zHelp326, 326, 0x011 },
  { "init",                     create_repository_cmd,        zHelp144, 144, 0x011 },
  { "interwiki",                interwiki_cmd,                zHelp350, 350, 0x012 },
#ifdef FOSSIL_ENABLE_JSON
  { "json",                     json_cmd_top,                 zHelp353, 353, 0x011 },
#endif
  { "keep-glob",                0,                            zHelp188, 188, 0x0e0 },
  { "large-file-size",          0,                            zHelp219, 219, 0x020 },
  { "leaves",                   leaves_cmd,                   zHelp231, 231, 0x012 },
  { "localauth",                0,                            zHelp189, 189, 0x120 },
  { "lock-timeout",             0,                            zHelp190, 190, 0x020 },
  { "login-group",              login_group_command,          zHelp367, 367, 0x012 },
  { "ls",                       ls_cmd,                       zHelp102, 102, 0x011 },
  { "main-branch",              0,                            zHelp191, 191, 0x020 },
  { "mainmenu",                 0,                            zHelp465, 465, 0x40a0 },
  { "manifest",                 0,                            zHelp192, 192, 0x060 },
  { "max-cache-entry",          0,                            zHelp072,  72, 0x020 },
  { "max-loadavg",              0,                            zHelp193, 193, 0x020 },
  { "max-upload",               0,                            zHelp194, 194, 0x020 },
  { "md5sum",                   md5sum_test,                  zHelp384, 384, 0x012 },
  { "merge",                    merge_cmd,                    zHelp387, 387, 0x011 },
  { "merge-base",               merge_base_cmd,               zHelp415, 415, 0x011 },
  { "merge-info",               merge_info_cmd,               zHelp385, 385, 0x011 },
  { "mimetypes",                0,                            zHelp195, 195, 0x0e0 },
  { "mtime-changes",            0,                            zHelp196, 196, 0x120 },
  { "mv",                       mv_cmd,                       zHelp006,   6, 0x011 },
  { "mv-rm-files",              0,                            zHelp197, 197, 0x120 },
  { "new",                      create_repository_cmd,        zHelp144, 144, 0x2010 },
  { "open",                     cmd_open,                     zHelp147, 147, 0x011 },
  { "patch",                    patch_cmd,                    zHelp407, 407, 0x011 },
  { "pgp-command",              0,                            zHelp198, 198, 0x420 },
  { "pikchr",                   pikchr_cmd,                   zHelp414, 414, 0x012 },
  { "praise",                   annotate_cmd,                 zHelp241, 241, 0x012 },
  { "preferred-diff-type",      0,                            zHelp333, 333, 0x020 },
  { "proxy",                    0,                            zHelp199, 199, 0x020 },
  { "publish",                  publish_cmd,                  zHelp420, 420, 0x012 },
  { "pull",                     pull_cmd,                     zHelp520, 520, 0x011 },
  { "purge",                    purge_cmd,                    zHelp421, 421, 0x012 },
  { "push",                     push_cmd,                     zHelp521, 521, 0x011 },
  { "raw-bgcolor",              0,                            zHelp116, 116, 0x120 },
  { "rebuild",                  rebuild_database,             zHelp423, 423, 0x011 },
  { "reconstruct",              reconstruct_cmd,              zHelp429, 429, 0x012 },
  { "redirect-to-https",        0,                            zHelp200, 200, 0x020 },
  { "redo",                     undo_cmd,                     zHelp570, 570, 0x012 },
  { "regexp-limit",             0,                            zHelp431, 431, 0x020 },
  { "relative-paths",           0,                            zHelp201, 201, 0x120 },
  { "remote",                   remote_url_cmd,               zHelp523, 523, 0x011 },
  { "remote-url",               remote_url_cmd,               zHelp523, 523, 0x012 },
  { "rename",                   mv_cmd,                       zHelp006,   6, 0x012 },
  { "repack",                   repack_command,               zHelp422, 422, 0x011 },
  { "reparent",                 reparent_cmd,                 zHelp528, 528, 0x012 },
  { "repo-cksum",               0,                            zHelp202, 202, 0x120 },
  { "repolist-skin",            0,                            zHelp203, 203, 0x020 },
  { "revert",                   revert_cmd,                   zHelp577, 577, 0x011 },
  { "rm",                       delete_cmd,                   zHelp002,   2, 0x011 },
  { "robot-exception",          0,                            zHelp443, 443, 0x0a0 },
  { "robot-restrict",           0,                            zHelp442, 442, 0x0a0 },
  { "robots-txt",               0,                            zHelp518, 518, 0x40a0 },
  { "rss",                      cmd_timeline_rss,             zHelp447, 447, 0x012 },
  { "safe-html",                0,                            zHelp616, 616, 0x020 },
  { "scrub",                    scrub_cmd,                    zHelp427, 427, 0x012 },
  { "search",                   search_cmd,                   zHelp449, 449, 0x012 },
  { "self-pw-reset",            0,                            zHelp204, 204, 0x520 },
  { "self-register",            0,                            zHelp205, 205, 0x520 },
  { "server",                   cmd_webserver,                zHelp376, 376, 0x012 },
  { "settings",                 setting_cmd,                  zHelp220, 220, 0x011 },
  { "sha1sum",                  sha1sum_test,                 zHelp484, 484, 0x012 },
  { "sha3sum",                  sha3sum_test,                 zHelp485, 485, 0x012 },
  { "shell",                    shell_cmd,                    zHelp312, 312, 0x012 },
  { "sitemap-extra",            0,                            zHelp466, 466, 0x0a0 },
  { "sql",                      cmd_sqlite3,                  zHelp501, 501, 0x011 },
  { "sqlar",                    sqlar_cmd,                    zHelp628, 628, 0x012 },
  { "sqlite3",                  cmd_sqlite3,                  zHelp501, 501, 0x012 },
  { "ssh-command",              0,                            zHelp206, 206, 0x420 },
  { "ssl-ca-location",          0,                            zHelp207, 207, 0x420 },
  { "ssl-config",               test_tlsconfig_info,          zHelp322, 322, 0x8011 },
  { "ssl-identity",             0,                            zHelp208, 208, 0x420 },
  { "stash",                    stash_cmd,                    zHelp503, 503, 0x011 },
  { "status",                   status_cmd,                   zHelp100, 100, 0x011 },
  { "sync",                     sync_cmd,                     zHelp522, 522, 0x011 },
  { "tag",                      tag_cmd,                      zHelp527, 527, 0x011 },
  { "tarball",                  tarball_cmd,                  zHelp532, 532, 0x012 },
#ifdef FOSSIL_ENABLE_TCL
  { "tcl",                      0,                            zHelp209, 209, 0x520 },
#endif
#ifdef FOSSIL_ENABLE_TCL
  { "tcl-setup",                0,                            zHelp210, 210, 0x4a0 },
#endif
  { "tclsh",                    0,                            zHelp211, 211, 0x420 },
  { "test-add-alerts",          test_add_alert_cmd,           zHelp030,  30, 0x014 },
  { "test-agg-cksum",           test_agg_cksum_cmd,           zHelp592, 592, 0x014 },
  { "test-alert",               test_alert_cmd,               zHelp029,  29, 0x014 },
  { "test-all-help",            test_all_help_cmd,            zHelp247, 247, 0x014 },
  { "test-ambiguous",           test_ambiguous_cmd,           zHelp396, 396, 0x014 },
  { "test-ancestor-path",       ancestor_path_test_cmd,       zHelp409, 409, 0x014 },
  { "test-approx-match",        test_approx_match_command,    zHelp249, 249, 0x014 },
  { "test-artifact-to-json",    test_manifest_to_json,        zHelp383, 383, 0x014 },
  ...
  { "test-canonical-name",      cmd_test_canonical_name,      zHelp283, 283, 0x014 },
  { "test-captcha",             test_captcha,                 zHelp076,  76, 0x014 },
  { "test-case-filename",       test_preferred_fn,            zHelp280, 280, 0x014 },
  { "test-chat-formatter",      chat_test_formatter_cmd,      zHelp092,  92, 0x014 },
  { "test-ci-mini",             test_ci_mini_cmd,             zHelp291, 291, 0x014 },
  { "test-clusters",            test_clusters_cmd,            zHelp426, 426, 0x014 },
  { "test-command-stats",       test_command_stats_cmd,       zHelp248, 248, 0x014 },
  { "test-comment-format",      test_comment_format,          zHelp121, 121, 0x014 },
  { "test-commit-warning",      test_commit_warning,          zHelp107, 107, 0x014 },
  { "test-compress",            compress_cmd,                 zHelp052,  52, 0x014 },
  { "test-compress-2",          compress2_cmd,                zHelp053,  53, 0x014 },
  { "test-contains-selector",   contains_selector_cmd,        zHelp512, 512, 0x014 },
  { "test-content-deltify",     test_content_deltify_cmd,     zHelp130, 130, 0x014 },
  { "test-content-erase",       test_content_erase,           zHelp134, 134, 0x014 },
  { "test-content-put",         test_content_put_cmd,         zHelp128, 128, 0x014 },
  { "test-content-rawget",      test_content_rawget_cmd,      zHelp127, 127, 0x014 },
  { "test-content-undelta",     test_content_undelta_cmd,     zHelp129, 129, 0x014 },
  { "test-convert-stext",       test_convert_stext,           zHelp452, 452, 0x014 },
  { "test-create-clusters",     test_createcluster_cmd,       zHelp425, 425, 0x014 },
  { "test-crosslink",           test_crosslink_cmd,           zHelp382, 382, 0x014 },
  { "test-cycle-compress",      test_cycle_compress,          zHelp055,  55, 0x014 },
  { "test-database-names",      test_database_name_cmd,       zHelp224, 224, 0x014 },
  { "test-date",                test_date,                    zHelp082,  82, 0x014 },
  { "test-date-format",         test_date_format,             zHelp106, 106, 0x014 },
  { "test-db-exec-error",       db_test_db_exec_cmd,          zHelp137, 137, 0x014 },
  { "test-db-prepare",          db_test_db_prepare,           zHelp138, 138, 0x014 },
  { "test-decode64",            test_decode64_cmd,            zHelp263, 263, 0x014 },
  { "test-delta",               cmd_test_delta,               zHelp229, 229, 0x014 },
  { "test-delta-analyze",       delta_analyze_cmd,            zHelp227, 227, 0x014 },
  { "test-delta-apply",         delta_apply_cmd,              zHelp228, 228, 0x014 },
  { "test-delta-create",        delta_create_cmd,             zHelp226, 226, 0x014 },
  { "test-describe-artifacts",  test_describe_artifacts_cmd,  zHelp397, 397, 0x014 },
  { "test-diff",                xdiff_cmd,                    zHelp235, 235, 0x014 },
  { "test-dir-size",            test_dir_size_cmd,            zHelp288, 288, 0x014 },
  { "test-echo",                test_echo_cmd,                zHelp378, 378, 0x014 },
  { "test-email-used",          test_email_used,              zHelp364, 364, 0x014 },
  { "test-encode64",            test_encode64_cmd,            zHelp262, 262, 0x014 },
  { "test-endpoint",            timeline_test_endpoint,       zHelp542, 542, 0x014 },
  { "test-escaped-arg",         test_escaped_arg_command,     zHelp056,  56, 0x014 },
  { "test-etag",                test_etag_cmd,                zHelp265, 265, 0x014 },
  { "test-file-copy",           test_file_copy,               zHelp276, 276, 0x014 },
  { "test-file-environment",    cmd_test_file_environment,    zHelp282, 282, 0x014 },
  { "test-fileage",             test_fileage_cmd,             zHelp063,  63, 0x014 },
  { "test-filezip",             filezip_cmd,                  zHelp626, 626, 0x014 },
  { "test-find-mx",             test_find_mx,                 zHelp497, 497, 0x014 },
  { "test-fingerprint",         test_fingerprint,             zHelp225, 225, 0x014 },
  { "test-forumthread",         forumthread_cmd,              zHelp297, 297, 0x014 },
  { "test-fossil-system",       test_fossil_system_cmd,       zHelp587, 587, 0x014 },
  { "test-fuzz",                fuzz_command,                 zHelp314, 314, 0x014 },
  { "test-generate-uuid",       test_generate_uuid,           zHelp589, 589, 0x014 },
  { "test-glob",                glob_test_cmd,                zHelp315, 315, 0x014 },
  { "test-grep",                re_test_grep,                 zHelp432, 432, 0x014 },
  { "test-gzip",                test_gzip_cmd,                zHelp316, 316, 0x014 },
  { "test-hash-color",          test_hash_color,              zHelp118, 118, 0x014 },
#if 0
  { "test-hash-from-path*",     test_hash_from_path_cmd,      zHelp428, 428, 0x014 },
#endif
  { "test-hash-passwords",      user_hash_passwords_cmd,      zHelp582, 582, 0x014 },
  { "test-html-tidy",           test_html_tidy,               zHelp614, 614, 0x014 },
  { "test-html-to-text",        test_html_to_text,            zHelp615, 615, 0x014 },
  { "test-html-tokenize",       test_html_tokenize,           zHelp613, 613, 0x014 },
  { "test-http",                cmd_test_http,                zHelp375, 375, 0x014 },
  { "test-httpmsg",             test_httpmsg_command,         zHelp321, 321, 0x014 },
  { "test-integrity",           test_integrity,               zHelp131, 131, 0x014 },
#if defined(_WIN32)
  { "test-is-normal-dir",       test_is_normal_dir,           zHelp278, 278, 0x014 },
#endif
  { "test-is-repo",             test_is_repo,                 zHelp142, 142, 0x014 },
  { "test-is-reserved-name",    test_is_reserved_name_cmd,    zHelp290, 290, 0x014 },
  { "test-ishuman",             test_ishuman,                 zHelp358, 358, 0x014 },
  { "test-isspace",             isspace_cmd,                  zHelp050,  50, 0x014 },
  { "test-js-once",             test_js_once,                 zHelp069,  69, 0x014 },
  { "test-leaf-ambiguity",      leaf_ambiguity_warning_test,  zHelp354, 354, 0x014 },
  { "test-line-diff",           test_line_diff,               zHelp233, 233, 0x014 },
  { "test-line-match",          test_dline_match,             zHelp234, 234, 0x014 },
  { "test-line-numbers",        cmd_test_line_numbers,        zHelp339, 339, 0x014 },
  { "test-list-attachments",    test_list_attachments,        zHelp041,  41, 0x014 },
  { "test-list-page",           test_list_page,               zHelp435, 435, 0x014 },
  { "test-list-webpage",        cmd_test_webpage_list,        zHelp252, 252, 0x014 },
  { "test-loadavg",             loadavg_test_cmd,             zHelp355, 355, 0x014 },
  { "test-looks-like-attack",   test_looks_like_attack,       zHelp369, 369, 0x014 },
  { "test-looks-like-utf",      looks_like_utf_test_cmd,      zHelp368, 368, 0x014 },
  { "test-mailbox-hashname",    alert_test_mailbox_hashname,  zHelp010,  10, 0x014 },
  { "test-manifest-setting",    test_manfest_setting_cmd,     zHelp146, 146, 0x014 },
  { "test-markdown-render",     test_markdown_render,         zHelp612, 612, 0x014 },
  { "test-match",               test_match_cmd,               zHelp448, 448, 0x014 },
  { "test-mimetype",            mimetype_test_cmd,            zHelp254, 254, 0x014 },
  { "test-missing",             test_missing,                 zHelp133, 133, 0x014 },
  { "test-move-repository",     move_repo_cmd,                zHelp143, 143, 0x014 },
  { "test-name-changes",        test_name_change,             zHelp410, 410, 0x014 },
  { "test-name-to-id",          test_name_to_id,              zHelp392, 392, 0x014 },
  { "test-obscure",             test_obscure_cmd,             zHelp264, 264, 0x014 },
  { "test-orphans",             test_orphans,                 zHelp132, 132, 0x014 },
  { "test-parse-all-blobs",     manifest_test_parse_all_blobs_cmd,    zHelp381, 381, 0x014 },
  { "test-parse-manifest",      manifest_test_parse_cmd,      zHelp380, 380, 0x014 },
  { "test-phantoms",            test_phatoms_cmd,             zHelp404, 404, 0x014 },
  { "test-pqueue",              pqueuex_test_cmd,             zHelp416, 416, 0x014 },
  { "test-process-id",          test_process_id_command,      zHelp046,  46, 0x014 },
  { "test-prompt-password",     test_prompt_password_cmd,     zHelp584, 584, 0x014 },
  { "test-prompt-user",         test_prompt_user_cmd,         zHelp583, 583, 0x014 },
  { "test-random-password",     test_random_password,         zHelp588, 588, 0x014 },
  { "test-relative-name",       cmd_test_relative_name,       zHelp284, 284, 0x014 },
  { "test-relink-wiki",         test_wiki_relink_cmd,         zHelp045,  45, 0x014 },
  { "test-reserved-names",      test_reserved_names,          zHelp000,   0, 0x014 },
  { "test-resetpw-url",         test_resetpw_url,             zHelp362, 362, 0x014 },
  { "test-safe-html",           test_safe_html_cmd,           zHelp617, 617, 0x014 },
  { "test-sanitize-name",       test_sanitize_name_cmd,       zHelp272, 272, 0x014 },
  { "test-search-stext",        test_search_stext,            zHelp451, 451, 0x014 },
  { "test-set-mtime",           test_set_mtime,               zHelp277, 277, 0x014 },
  { "test-shortest-path",       shortest_path_test_cmd,       zHelp408, 408, 0x014 },
  { "test-show-vfile",          test_show_vfile_cmd,          zHelp386, 386, 0x014 },
  { "test-simplify-name",       cmd_test_simplify_name,       zHelp279, 279, 0x014 },
  { "test-smtp-probe",          test_smtp_probe,              zHelp498, 498, 0x014 },
  { "test-smtp-send",           test_smtp_send,               zHelp500, 500, 0x014 },
  { "test-smtp-senddata",       test_smtp_senddata,           zHelp499, 499, 0x014 },
  { "test-ssh-needs-path",      test_ssh_needs_path,          zHelp320, 320, 0x014 },
  { "test-strip-comment-lines", test_strip_comment_lines_cmd, zHelp051,  51, 0x014 },
  { "test-subtree",             test_subtree_cmd,             zHelp070,  70, 0x014 },
  { "test-symlink-list",        test_symlink_list_cmd,        zHelp348, 348, 0x014 },
  { "test-tag",                 testtag_cmd,                  zHelp526, 526, 0x014 },
  { "test-tarball",             test_tarball_cmd,             zHelp531, 531, 0x014 },
  { "test-tempname",            file_test_tempname,           zHelp286, 286, 0x014 },
  { "test-terminal-size",       test_terminal_size_cmd,       zHelp534, 534, 0x014 },
  { "test-th-eval",             test_th_eval,                 zHelp537, 537, 0x014 },
#ifdef FOSSIL_ENABLE_TH1_HOOKS
  { "test-th-hook",             test_th_hook,                 zHelp539, 539, 0x014 },
#endif
  { "test-th-render",           test_th_render,               zHelp536, 536, 0x014 },
  { "test-th-source",           test_th_source,               zHelp538, 538, 0x014 },
  { "test-ticket-rebuild",      test_ticket_rebuild,          zHelp548, 548, 0x014 },
  { "test-timespan",            test_timespan_cmd,            zHelp222, 222, 0x014 },
  { "test-timewarp-list",       test_timewarp_cmd,            zHelp546, 546, 0x014 },
  { "test-topological-sort",    test_topological_sort,        zHelp271, 271, 0x014 },
  { "test-tree-name",           cmd_test_tree_name,           zHelp285, 285, 0x014 },
  { "test-unclustered",         test_unclusterd_cmd,          zHelp403, 403, 0x014 },
  { "test-uncompress",          uncompress_cmd,               zHelp054,  54, 0x014 },
  { "test-unsent",              test_unsent_cmd,              zHelp402, 402, 0x014 },
  { "test-url-basename",        cmd_test_url_basename,        zHelp579, 579, 0x014 },
  { "test-urlparser",           cmd_test_urlparser,           zHelp578, 578, 0x014 },
  { "test-user-caps-changed",   test_user_caps_changed,       zHelp481, 481, 0x014 },
  { "test-usernames",           test_usernames_cmd,           zHelp581, 581, 0x014 },
  { "test-valid-for-windows",   file_test_valid_for_windows,  zHelp287, 287, 0x014 },
  { "test-var-get",             test_var_get_cmd,             zHelp124, 124, 0x014 },
  { "test-var-list",            test_var_list_cmd,            zHelp123, 123, 0x014 },
  { "test-var-set",             test_var_set_cmd,             zHelp125, 125, 0x014 },
  { "test-verify-all",          verify_all_cmd,               zHelp591, 591, 0x014 },
  { "test-whatis-all",          test_whatis_all_cmd,          zHelp395, 395, 0x014 },
  { "test-which",               test_which_cmd,               zHelp281, 281, 0x014 },
  { "test-wiki-render",         test_wiki_render,             zHelp611, 611, 0x014 },
  { "test-without-rowid",       test_without_rowid,           zHelp223, 223, 0x014 },
  { "test-xfer",                cmd_test_xfer,                zHelp620, 620, 0x014 },
#ifdef FOSSIL_ENABLE_TH1_DOCS
  { "th1-docs",                 0,                            zHelp212, 212, 0x520 },
#endif
#ifdef FOSSIL_ENABLE_TH1_HOOKS
  { "th1-hooks",                0,                            zHelp213, 213, 0x120 },
#endif
  { "th1-setup",                0,                            zHelp214, 214, 0x4a0 },
  { "th1-uri-regexp",           0,                            zHelp215, 215, 0x0a0 },
  { "ticket",                   ticket_cmd,                   zHelp556, 556, 0x012 },
  { "ticket-default-report",    0,                            zHelp436, 436, 0x020 },
  { "timeline",                 timeline_cmd,                 zHelp544, 544, 0x011 },
  { "timeline-hard-newlines",   0,                            zHelp418, 418, 0x120 },
  { "timeline-plaintext",       0,                            zHelp417, 417, 0x120 },
  { "timeline-truncate-at-blank", 0,                            zHelp540, 540, 0x120 },
  { "timeline-tslink-info",     0,                            zHelp541, 541, 0x120 },
  { "timeline-utc",             0,                            zHelp139, 139, 0x120 },
  { "tls-config",               test_tlsconfig_info,          zHelp322, 322, 0x8012 },
  { "touch",                    touch_cmd,                    zHelp289, 289, 0x012 },
  { "tree",                     tree_cmd,                     zHelp103, 103, 0x011 },
  { "ui",                       cmd_webserver,                zHelp376, 376, 0x011 },
  { "undo",                     undo_cmd,                     zHelp570, 570, 0x011 },
  { "unpublished",              unpublished_cmd,              zHelp419, 419, 0x012 },
  { "unset",                    setting_cmd,                  zHelp220, 220, 0x012 },
  { "unversioned",              unversioned_cmd,              zHelp572, 572, 0x8011 },
  { "update",                   update_cmd,                   zHelp576, 576, 0x011 },
  { "user",                     user_cmd,                     zHelp580, 580, 0x012 },
  { "user-color-map",           0,                            zHelp117, 117, 0x0a0 },
  { "uv",                       unversioned_cmd,              zHelp572, 572, 0xa010 },
  { "uv-sync",                  0,                            zHelp217, 217, 0x120 },
  { "verify-comments",          0,                            zHelp108, 108, 0x020 },
  { "version",                  version_cmd,                  zHelp370, 370, 0x011 },
  { "vuln-report",              0,                            zHelp535, 535, 0x020 },
  { "web-browser",              0,                            zHelp218, 218, 0x420 },
  { "whatis",                   whatis_cmd,                   zHelp394, 394, 0x012 },
  { "which",                    test_app_on_path,             zHelp590, 590, 0x012 },
  { "wiki",                     wiki_cmd,                     zHelp610, 610, 0x012 },
#ifdef _WIN32
  { "winsrv",                   cmd_win32_service,            zHelp618, 618, 0x012 },
#endif
  { "xdiff",                    xdiff_cmd,                    zHelp235, 235, 0x011 },
  { "zip",                      zip_cmd,                      zHelp627, 627, 0x012 },
};
#define FOSSIL_FIRST_CMD 237
#define FOSSIL_MX_CMDNAME 26 /* max length of any command name */
#define FOSSIL_MX_CMDIDX 631 /* max index for commands */
const Setting aSetting[] = {
  { "access-log",           0,                   0, 0, 0, 0, "on"         },
  { "admin-log",            0,                   0, 0, 0, 0, "on"         },
  { "allow-symlinks",       0,                   0, 0, 0, 1, "off"        },
  { "anon-cookie-lifespan", 0,                  10, 0, 0, 0, "480"        },
