#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil\\src\\robot.c"
/*
...
static void ask_for_proof_that_client_is_not_robot(void){
  ...
  cgi_printf("<h1 id=\"x1\">Checking to see if you are a robot<span id=\"x2\"></span></h1>\n"
  ...
  cgi_printf("<input id=\"x4\" type=\"hidden\" name=\"proof\" value=\"0\">\n"
         "</form>\n"
         "<script nonce='%s'>\n"
  ...
  p4 = (p2/k2)%k3;
  p5 = p2/(k2*k3);
  cgi_printf("function ccc(a,b,c){return (a*%u+b)*%u+c;}"
         "window.addEventListener('load',function(){"
         "bbb(ccc(%u,%u,%u),%u);},false);\n",(k3),(k2),(p5),(p4),(p3),(k));
  ...
  ** information: <https://stackoverflow.com/a/43043658>. */
  cgi_printf("window.addEventListener('pageshow',function(e){if(e.persisted)"
...
void robot_restrict_test_page(void){
  ...
  cgi_printf("<h1>Captcha passed</h1>\n"
         "\n"
         "<p>\n");
  if( zP1 && zP1[0] ){
     cgi_printf("proof=%h<br>\n",(zP1));
  }
  if( zP2 && zP2[0] ){
    cgi_printf("%h=%h<br>\n",(ROBOT_COOKIE),(zP2));
  ...
  if( g.perm.Admin ){
    ...
    if( z && z[0] ){
      cgi_printf("robot-restrict=%h</br>\n",(z));
    }
    cgi_printf("robot.h1=%u<br>\n"
           "robot.h2=%u<br>\n",(robot.h1),(robot.h2));
    switch( robot.resultCache ){
      case MIGHT_BE_ROBOT: {
        cgi_printf("robot.resultCache=MIGHT_BE_ROBOT<br>\n");
        break;
      }
      case KNOWN_NOT_ROBOT: {
        cgi_printf("robot.resultCache=KNOWN_NOT_ROBOT<br>\n");
        break;
      }
      default: {
        cgi_printf("robot.resultCache=OTHER (%d)<br>\n",(robot.resultCache));
        break;
      }
    }
  }
  cgi_printf("</p>\n"
         "<p><a href=\"%R/test-robotck/%h\">Retry</a>\n",(zName));
  style_finish_page();
}
...
void tokens_page(void){
  ...
  if( g.zLogin==0 || fossil_strcmp(g.zLogin,"anonymous")==0 ){
    cgi_printf("User \"%h\" is not allowed to\n"
           "own or use access tokens.\n",(g.zLogin?g.zLogin:"anonymous"));
    style_finish_page();
    return;
  }
  ...
  if( zMyToken==0 ){
    cgi_printf("<p>You do not currently have an access token.\n"
           "<a href=\"%R/tokens?new=true\">Create one</a>\n");
  }else{
    cgi_printf("<p>Your access token is \"%h\". \n"
           ...
           "server.\n"
           "<p><a href=\"%R/tokens?selfdel=%h\">Delete my token</a>\n",(zMyToken),(zMyToken));
  }
  if( g.perm.Admin ){
    int nTok = 0;
    Stmt s;
    ...
    while( db_step(&s)==SQLITE_ROW ){
      ...
      cgi_printf("<tr><td>%h\n"
             "<td>%h\n"
             "<td>%h\n"
             "<td><a href=\"%R/tokens?del=%h\">delete</a>\n"
             "</tr>\n",(db_column_text(&s,1)),(db_column_text(&s,0)),(db_column_text(&s,2)),(db_column_text(&s,0)));
    }
    db_finalize(&s);
    if( nTok==0 ){
      cgi_printf("<hr>\n"
