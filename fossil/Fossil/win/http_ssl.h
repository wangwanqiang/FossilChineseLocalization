...
#if defined(FOSSIL_ENABLE_SSL)
LOCAL void ssl_remember_certificate_exception(UrlData *pUrlData,const char *zHash);
#endif
int fossil_stricmp(const char *zA,const char *zB);
char *blob_str(Blob *p);
void prompt_user(const char *zPrompt,Blob *pIn);
#if defined(FOSSIL_ENABLE_SSL)
LOCAL void ssl_one_time_exception(UrlData *pUrlData,const char *zHash);
LOCAL int ssl_certificate_exception_exists(UrlData *pUrlData,const char *zHash);
#endif
