...
void style_submenu_sql(const char *zName,const char *zLabel,const char *zFormat,...);
void style_submenu_multichoice(const char *zName,int nChoice,const char *const *azChoice,int eVisible);
void style_submenu_binary(const char *zName,const char *zTrue,const char *zFalse,int eVisible);
