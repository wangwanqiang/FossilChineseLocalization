#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\chat.c"
/*
...
void chat_webpage(void){
  ...
  style_header("Chat");
  cgi_printf("<div id='chat-input-area'>\n"
         ...
         "<div id='chat-config-options'></div>\n",(zInputPlaceholder0),(zInputPlaceholder0),(zInputPlaceholder0),(zInputPlaceholder0),(zInputPlaceholder0),(zInputPlaceholder0));
    /* ^^^populated client-side */
  cgi_printf("<div class='button-bar'><button class='action-close'>Close Settings</button></div>\n"
         "</div>\n"
         "<div id='chat-search' class='hidden chat-view'>\n"
         "  <div id='chat-search-content'></div>\n");
      /* ^^^populated client-side */
  cgi_printf("  <div class='button-bar'>\n"
  ...
  cgi_printf("<span id='message-inject-point'></span>\n"
         "</div>\n");
  ...
  cgi_printf("<script nonce=\"%h\">/* chat.c:%d */\n",(style_nonce()),(__LINE__));
  /* We need an onload handler to ensure that window.fossil is
     initialized before the chat init code runs. */
  cgi_printf("window.addEventListener('load', function(){\n"
         ...
         "  imagesInline: !!%d,\n"
         "  pollTimeout: %d\n"
         "};\n",(PB("cli")?"true":"false"),(zAlert),(db_get_int("chat-initial-history",50)),(db_get_boolean("chat-inline-images",1)),(db_get_int("chat-poll-timeout",420)));
...
void chat_download_webpage(void){
  ...
  if( !g.perm.Chat ){
    ...
    cgi_printf("<h1>Not Authorized</h1>\n"
