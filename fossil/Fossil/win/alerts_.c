#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\alerts.c"
/*
...
static int alert_webpages_disabled(void){
  ...
  cgi_printf("<p>Email alerts are disabled on this server</p>\n");
  style_finish_page();
  return 1;
}
...
void setup_notification(void){
  ...
  cgi_printf("<form action=\"%R/setup_notification\" method=\"post\"><div>\n"
  ...
  entry_attribute("Administrator email address", 40, "email-admin",
                   "eadmin", "", 0);
  cgi_printf("<p>This is the email for the human administrator for the system.\n"
  ...
  cgi_printf("<p>How to send email.  Requires auxiliary information from the fields\n"
  ...
  entry_attribute("SMTP Relay Host", 60, "email-send-relayhost",
                   "esrh", "localhost", 0);
  cgi_printf("<p>When the send method is \"SMTP relay\", each email message is\n"
  ...
  entry_attribute("Store Emails In This Database", 60, "email-send-db",
                   "esdb", "", 0);
  cgi_printf("<p>When the send method is \"store in a database\", each email message is\n"
  ...
  entry_attribute("Pipe Email Text Into This Command", 60, "email-send-command",
                   "ecmd", "sendmail -ti", 0);
  cgi_printf("<p>When the send method is \"pipe to a command\", this is the command\n"
  ...
  entry_attribute("Store Emails In This Directory", 60, "email-send-dir",
                   "esdir", "", 0);
  cgi_printf("<p>When the send method is \"store in a directory\", each email message is\n"
...
void subscribe_page(void){
   ...
   && subscribe_error_check(&eErr,&zErr,needCaptcha)
    ...
    if( !needCaptcha ){
      ...
      */
      ...
      if( pSender->zErr ){
        cgi_printf("<h1>Internal Error</h1>\n"
        ...
        cgi_printf("<p>An email has been sent to \"%h\". That email contains a\n"
  ...
  cgi_printf("<p>To receive email notifications for changes to this\n"
         "repository, fill out the form below and press the \"Submit\" button.</p>\n");
  form_begin(0, "%R/subscribe");
  cgi_printf("<table class=\"subscribe\">\n"
         "<tr>\n"
         " <td class=\"form_label\">Email&nbsp;Address:</td>\n"
         " <td><input type=\"text\" name=\"e\" value=\"%h\" size=\"30\"></td>\n"
         "<tr>\n",(PD("e","")));
  if( eErr==1 ){
    cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  }
  cgi_printf("</tr>\n");
  if( needCaptcha ){
    const char *zInit = "";
    ...
    cgi_printf("<tr>\n"
           ...
           " <td><input type=\"text\" name=\"captcha\" value=\"%h\" size=\"30\">\n",(zInit));
    captcha_speakit_button(uSeed, "Speak the code");
    cgi_printf(" <input type=\"hidden\" name=\"captchaseed\" value=\"%u\"></td>\n"
           "</tr>\n",(uSeed));
    if( eErr==2 ){
      cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
    }
  ...
  if( g.perm.Admin ){
    cgi_printf("<tr>\n"
           ...
           " <td><input type=\"text\" name=\"suname\" value=\"%h\" "
           " size=\"30\"></td>\n"
           "</tr>\n",(PD("suname",g.zLogin)));
    if( eErr==3 ){
      cgi_printf("<tr><td><td><span class='loginError'>&uarr; %h</span></td></tr>\n",(zErr));
  ...
  cgi_printf("<tr>\n"
         ...
         " <td><label><input type=\"checkbox\" name=\"sa\" %s> "
         " Announcements</label><br>\n",(PCK("sa")));
  if( g.perm.Read ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"sc\" %s> "
           " Check-ins</label><br>\n",(PCK("sc")));
  }
  if( g.perm.RdForum ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"sf\" %s> "
           " All Forum Posts</label><br>\n"
           " <label><input type=\"checkbox\" name=\"sn\" %s> "
           " New Forum Threads</label><br>\n"
           " <label><input type=\"checkbox\" name=\"sr\" %s> "
           " Replies To My Forum Posts</label><br>\n"
           " <label><input type=\"checkbox\" name=\"sx\" %s> "
           " Edits To Forum Posts</label><br>\n",(PCK("sf")),(PCK("sn")),(PCK("sr")),(PCK("sx")));
  }
  if( g.perm.RdTkt ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"st\" %s> "
           " Ticket changes</label><br>\n",(PCK("st")));
  }
  if( g.perm.RdWiki ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"sw\" %s> "
           " Wiki</label><br>\n",(PCK("sw")));
  }
  if( g.perm.Admin ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"su\" %s> "
  ...
  cgi_printf("</td></tr>\n"
         ...
         "    <option value=\"0\" %s>Individual Emails</option>\n"
         "    <option value=\"1\" %s>Daily Digest</option>\n"
         "    </select></td>\n"
         "</tr>\n",(di?"":"selected"),(di?"selected":""));
  if( g.perm.Admin ){
    cgi_printf("<tr>\n"
           " <td class=\"form_label\">Admin Options:</td><td>\n"
           " <label><input type=\"checkbox\" name=\"vi\" %s> "
           " Verified</label><br>\n"
           " <label><input type=\"checkbox\" name=\"dnc\" %s> "
           " Do not call</label></td></tr>\n",(PCK("vi")),(PCK("dnc")));
  }
  cgi_printf("<tr>\n"
         " <td></td>\n");
  if( needCaptcha && !alert_enabled() ){
    cgi_printf(" <td><input type=\"submit\" name=\"submit\" value=\"Submit\" disabled>\n"
           " (Email current disabled)</td>\n");
  }else{
    cgi_printf(" <td><input type=\"submit\" name=\"submit\" value=\"Submit\"></td>\n");
  }
  cgi_printf("</tr>\n"
         "</table>\n");
  if( needCaptcha ){
    cgi_printf("<div class=\"captcha\"><table class=\"captcha\"><tr><td><pre class=\"captcha\">\n"
           "%h\n"
           "</pre>\n"
...
static void alert_unsubscribe(int sid, int bTotal){
  ...
  if( zEmail==0 ){
    ...
    cgi_printf("<p>Unable to locate a subscriber with the requested key</p>\n");
  }else{
    db_unprotect(PROTECT_READONLY);
    if( bTotal ){
    ...
    cgi_printf("<p>The \"%h\" email address has been unsubscribed from all\n"
           "notifications.  All subscription records for \"%h\" have\n"
           "been purged.  No further emails will be sent to \"%h\".</p>\n",(zEmail),(zEmail),(zEmail));
    if( uid && g.perm.Admin ){
       cgi_printf("<p>You may also want to\n"
              "<a href=\"%R/setup_uedit?id=%d\">edit or delete\n"
              "the corresponding user \"%h\"</a></p>\n",(uid),(zLogin));
    }
  }
  db_finalize(&q);
  style_finish_page();
...
void alert_page(void){
  ...
  if( !g.perm.Admin && !sverified ){
    if( nName==64 ){
      ...
      cgi_printf("<h1>Your email alert subscription has been verified!</h1>\n"
      ...
      cgi_printf("<h2>Your email address is unverified</h2>\n"
    ...
    cgi_printf("<p>Make changes to the email subscription shown below and\n"
           "press \"Submit\".</p>\n");
  }
  ...
  cgi_printf("<input type=\"hidden\" name=\"name\" value=\"%h\">\n"
         ...
         " <td class=\"form_label\">Email&nbsp;Address:</td>\n",(zHalfCode));
  if( isLogin ){
    cgi_printf(" <td><input type=\"text\" name=\"semail\" value=\"%h\" size=\"30\">",(semail));
    if( eErr==8 ){
      cgi_printf("<span class='loginError'>&larr; not a valid email address!</span>\n");
    }else if( g.perm.Admin ){
      cgi_printf("&nbsp;&nbsp;<a href=\"%R/announce?to=%t\">"
             "(Send a message to %h)</a>",(semail),(semail));
    }
    cgi_printf("</td>\n");
  }else{
    cgi_printf(" <td>%h</td>\n",(semail));
  ...
  if( g.perm.Admin ){
    ...
    cgi_printf("<tr>\n"
           ...
           " <td class=\"form_label\">User:</td>\n"
           " <td><input type=\"text\" name=\"suname\" value=\"%h\" "
           " size=\"30\">",(sctime),(mtime),(smip),(db_column_text(&q,9)),(db_column_text(&q,10)),(db_column_int(&q,11)),(suname?suname:""));
    uid = db_int(0, "SELECT uid FROM user WHERE login=%Q", suname);
    if( uid ){
      cgi_printf("&nbsp;&nbsp;<a href='%R/setup_uedit?id=%d'>"
             "(login info for %h)</a>",(uid),(suname));
    }
    cgi_printf("</tr>\n");
  }
  cgi_printf("<tr>\n"
  ...
  if( g.perm.RdForum ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"sf\" %s>"
           ...
           " <label><input type=\"checkbox\" name=\"sx\" %s>"
           " Edits To Forum Posts</label><br>\n",(sf?"checked":""),(sn?"checked":""),(sr?"checked":""),(sx?"checked":""));
  }
  if( g.perm.RdTkt ){
    cgi_printf(" <label><input type=\"checkbox\" name=\"st\" %s>"
           " Ticket changes</label><br>\n",(st?"checked":""));
...
void renewal_page(void){
  ...
  if( zName==0 || strlen(zName)<4 ){
    cgi_printf("<p>No subscription specified</p>\n");
    style_finish_page();
    return;
  }
  ...
  if( !db_table_has_column("repository","subscriber","lastContact")
   || iInterval<1
    ...
    cgi_printf("<p>This repository does not expire email notification subscriptions.\n"
  ...
  rc = db_step(&s);
  if( rc==SQLITE_ROW ){
    cgi_printf("<p>The email notification subscription for %h\n"
           "has been extended until %h UTC.\n",(db_column_text(&s,0)),(db_column_text(&s,1)));
  }else{
    cgi_printf("<p>No such subscriber-id: %h</p>\n",(zName));
  }
  db_finalize(&s);
  db_protect_pop();
  style_finish_page();
...
void unsubscribe_page(void){
  ...
  if( zName
   && (sid = db_int(0, "SELECT subscriberId FROM subscriber"
    ...
    if( P(zUnsubName)!=0 ){
      ...
      cgi_printf("<input type=\"hidden\" name=\"scode\" value=\"%h\">\n"
             "<table border=\"0\" cellpadding=\"10\" width=\"100%%\">\n"
             "<tr><td align=\"right\">\n"
             "<input type=\"submit\" name=\"%h\" value=\"Unsubscribe\">\n"
             "</td><td><big><b>&larr;</b></big></td>\n"
             "<td>Cancel your subscription to %h notifications\n"
             "</td><tr>\n"
             "<tr><td align=\"right\">\n"
  ...
  if( bSubmit ){
    ...
    ** been submitted.  Send the appropriate email. */
    ...
    if( pSender->zErr ){
      ...
      cgi_printf("<p>An email has been sent to \"%h\" that explains how to\n"
  ...
  */
  ...
  cgi_printf("<p>Fill out the form below to request an email message that will\n"
  ...
  cgi_printf("<table class=\"subscribe\">\n"
         ...
         " <td><input type=\"text\" name=\"e\" value=\"%h\" size=\"30\"></td>\n",(zEAddr));
  if( eErr==1 ){
    cgi_printf(" <td><span class=\"loginError\">&larr; %h</span></td>\n",(zErr));
  }
  cgi_printf("</tr>\n");
  uSeed = captcha_seed();
  zDecoded = captcha_decode(uSeed, 0);
  ...
  cgi_printf("</tr>\n"
         ...
         " <td><label><input type=\"radio\" name=\"dx\" value=\"0\" %s>"
         " Modify subscription</label><br>\n"
         " <label><input type=\"radio\" name=\"dx\" value=\"1\" %s>"
         ...
         "Enter the 8 characters above in the \"Security Code\" box<br/>\n"
         "</td></tr></table></div>\n"
         "</form>\n",(dx?"":"checked"),(dx?"checked":""),(zCaptcha));
  fossil_free(zErr);
  style_finish_page();
}
...
void subscriber_list_page(void){
  ...
  if( nPending>0 ){
    cgi_printf("<h1>%,d Subscribers, %,d Pending</h1>\n",(nTotal),(nPending));
    ...
    cgi_printf("<h1>%,d Subscribers</h1>\n",(nTotal));
  }
  if( nDel>0 ){
    cgi_printf("<p>*** %d pending subscriptions deleted ***</p>\n",(nDel));
  }
  blob_init(&sql, 0, 0);
  blob_append_sql(&sql,
  ...
  cgi_printf("<table border='1' class='sortable' "
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    cgi_printf("<tr>\n"
           "<td><a href='%R/alerts?sid=%d'>"
           "%h</a></td>\n"
           "<td>%h</td>\n"
           "<td>%s</td>\n",(db_column_int(&q,0)),(db_column_text(&q,1)),(db_column_text(&q,2)),(db_column_int(&q,5)?"digest":""));
    if( uid ){
      cgi_printf("<td><a href='%R/setup_uedit?id=%d'>%h</a>\n",(uid),(zUname));
    }else{
      cgi_printf("<td>%h</td>\n",(zUname));
    }
    cgi_printf("<td>%s</td>\n"
           "<td data-sortkey='%010llx'>%z</td>\n"
           "<td data-sortkey='%010llx'>",(db_column_int(&q,4)?"yes":"pending"),(iMtime),(human_readable_age(rAge)),(iContact));
    if( iContact>iWarning ){
      cgi_printf("<span>");
    }else if( iContact>iCutoff ){
      cgi_printf("<span style='background-color:%s;'>",(zWarnClr));
    }else{
      cgi_printf("<span style='background-color:%s;'>",(zCutoffClr));
    }
    cgi_printf("%z</td>\n"
           "<td>%h</td>\n"
           "</tr>\n",(human_readable_age(rContact)),(db_column_text(&q,7)));
  }
...
void contact_admin_page(void){
  ...
  if( zAdminEmail==0 || zAdminEmail[0]==0 ){
    ...
    cgi_printf("<p>Outbound email is disabled on this repository\n");
    style_finish_page();
    return;
  }
  if( P("submit")!=0
   ...
   && captcha_is_correct(0)
    ...
    if( pSender->zErr ){
      ...
      cgi_printf("<p>Your message has been sent to the repository administrator.\n"
  ...
  cgi_printf("<p>Enter a message to the repository administrator below:</p>\n"
         "<table class=\"subscribe\">\n");
  if( zCaptcha ){
    cgi_printf("<tr>\n"
           " <td class=\"form_label\">Security&nbsp;Code:</td>\n"
  ...
  cgi_printf("<tr>\n"
         ...
         " <td><input type=\"text\" name=\"from\" value=\"%h\" size=\"30\"></td>\n"
         "</tr>\n"
         "<tr>\n"
         " <td class=\"form_label\">Subject:</td>\n"
         " <td><input type=\"text\" name=\"subject\" value=\"%h\""
         " size=\"80\"></td>\n"
         "</tr>\n"
         "<tr>\n"
...
static char *alert_send_announcement(void){
  ...
  if( bTest && blob_size(&pSender->out) ){
    ...
    */
    ...
    cgi_printf("<pre style='border: 2px solid blue; padding: 1ex;'>\n"
           "%h\n"
           "</pre>\n",(blob_str(&pSender->out)));
...
void announce_page(void){
  ...
  */
  ...
  if( fossil_strcmp(zName,"test1")==0 ){
    ...
    cgi_printf("<p style='border: 1px solid black; padding: 1ex;'>\n");
    cgi_print_all(0, 0, 0);
    cgi_printf("</p>\n");
    ...
    if( zErr ){
      ...
      cgi_printf("<p>The announcement has been sent.\n"
             "<a href=\"%h\">Send another</a></p>\n",(PD("REQUEST_URI","/")));
    }
    style_finish_page();
    return;
  } else if( !alert_enabled() ){
    style_header("Cannot Send Announcement");
    cgi_printf("<p>Either you have no subscribers yet, or email alerts are not yet\n"
  ...
  cgi_printf("<form method=\"POST\" action=\"%R/%s\">\n",(zAction));
  login_insert_csrf_secret();
  cgi_printf("<table class=\"subscribe\">\n");
  if( g.perm.Admin ){
    int aa = PB("aa");
  ...
  cgi_printf("<tr>\n"
         ...
         "  <td></td>\n",(PT("subject")),(PT("msg")));
  if( fossil_strcmp(zName,"test2")==0 ){
    cgi_printf("  <td><input type=\"submit\" name=\"submit\" value=\"Dry Run\">\n");
  }else{
    cgi_printf("  <td><input type=\"submit\" name=\"submit\" value=\"Send Message\">\n");
  }
  cgi_printf("</tr>\n"
         "</table>\n"
         "</form>\n");
