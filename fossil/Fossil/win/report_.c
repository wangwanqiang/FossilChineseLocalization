#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\report.c"
/*
...
void view_see_sql(void){
  ...
  cgi_printf("<table cellpadding=0 cellspacing=0 border=0>\n"
         ...
         "<td valign=\"top\"><pre>\n"
         "<code class=\"language-sql\">%h</code>\n"
         "</pre></td>\n"
...
void view_edit(void){
  ...
  if( g.perm.Admin ){
    cgi_printf("<p>Report owner:\n"
           ...
           "</p>\n"
           "<p>Tag:\n"
           "<input type=\"text\" name=\"x\" size=\"20\" value=\"%h\">\n"
           "</p>\n",(zOwner),(zTag?zTag:""));
  } else {
    cgi_printf("<input type=\"hidden\" name=\"w\" value=\"%h\">\n",(zOwner));
    if( zTag && zTag[0] ){
      cgi_printf("<input type=\"hidden\" name=\"x\" value=\"%h\">\n",(zTag));
    }
  }
  ...
  cgi_printf("<p>Optional human-readable description for this report<br>\n"
         "%zMarkup style</a>:\n",(href("%R/markup_help")));
  mimetype_option_menu(zMimetype, "m");
  cgi_printf("<br><textarea aria-label=\"Description:\" name=\"d\" class=\"wikiedit\" "
         "cols=\"80\" rows=\"15\" wrap=\"virtual\">%h</textarea>\n"
         "</p>\n",(zDesc));

  cgi_printf("<p><label><input type=\"checkbox\" name=\"dflt\" %s> "
...
static int generate_html(
  ...
  */
  if( pState->iNewRow>=0 ){
    cgi_printf("<tr><td colspan=\"%d\" style=\"padding:0px\">\n"
...
void rptview_page_content(
  ...
  if( !tabs ){
    ...
    cgi_printf("<table border=\"1\" cellpadding=\"2\" cellspacing=\"0\" class=\"report sortable\"\n"
