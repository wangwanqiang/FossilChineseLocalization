#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\tag.c"
/*
...
void taglist_page(void){
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    cgi_printf("<tr><td data-sortkey=\"%06x\">",(rn));
    if( g.perm.Hyperlink ){
      cgi_printf("%z%h</a></td>",(chref("taglink","%R/timeline?t=%T",zName)),(zName));
    }else{
      cgi_printf("<span class=\"tagDsp\">%h</span></td>",(zName));
    }
    cgi_printf("<td>&nbsp;&nbsp;&nbsp;%h&nbsp;&nbsp;&nbsp;</td>"
