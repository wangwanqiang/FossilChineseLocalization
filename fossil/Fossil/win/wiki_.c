#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\wiki.c"
/*
  ...
  if( zMimetype==0 || fossil_strcmp(zMimetype, "text/x-fossil-wiki")==0 ){
    ...
    if( w>0 ){
      if( isPopup ) cgi_set_content_type("image/svg+xml");
        ...
        cgi_printf("<div class=\"pikchr-svg\" style=\"max-width:%dpx\">\n",(w));
      }
      cgi_printf("%s\n",(zOut));
      if( !isPopup){
        cgi_printf("</div>\n");
      ...
      cgi_printf("<pre class='error'>\n"
             "%h\n"
             "</pre>\n",(zOut));
    }
    free(zOut);
  }else{
    cgi_printf("<pre class='textPlain'>\n"
           "%h\n"
           "</pre>\n",(blob_str(pWiki)));
  }
}
...
void markup_help_page(void){
  ...
  cgi_printf("<ul>\n"
         "<li><p>%zFossil Wiki Formatting Rules</a></p></li>\n"
         "<li><p>%zMarkdown Formatting Rules</a></p></li>\n"
...
void wiki_helppage(void){
  ...
  cgi_printf("<h2>Wiki Links</h2>\n"
         "<ul>\n"
         "<li> %zRecent changes</a> to wiki pages.</li>\n"
         "<li> Formatting rules for %zFossil Wiki</a> and for\n"
         "%zMarkdown Wiki</a>.</li>\n"
         "<li> Use the %zSandbox</a>\n"
         "     to experiment.</li>\n",(href("%R/timeline?y=w")),(href("%R/wiki_rules")),(href("%R/md_rules")),(href("%R/wikiedit?name=Sandbox")));
  if( g.perm.NewWiki ){
  ...
  cgi_printf("<li> %zList of All Wiki Pages</a>\n"
         ...
         "<li> %zList of All Tech-notes</a>\n"
         "     available on this server.</li>\n",(href("%R/wcontent")),(href("%R/timeline?y=e")));
  if( g.perm.ModWiki ){
...
void wiki_page(void){
  ...
  if( zBody[0]==0 ){
    cgi_printf("<i>This page has been deleted</i>\n");
  }else{
...
void mimetype_option_menu(const char *zMimetype, const char *zParam){
  unsigned i;
  cgi_printf("<select name=\"%s\" size=\"1\">\n",(zParam));
  for(i=0; i<count(azStyles); i+=3){
...
void wikiappend_page(void){
  ...
  if( isSandbox ){
    cgi_printf("<p class=\"generalError\">Error: the Sandbox page may not\n"
           "be appended to.</p>\n");
  }
...
void whistory_page(void){
  ...
  cgi_printf("<h2>History of <a href=\"%R/wiki?name=%T\">%h</a></h2>\n",(zPageName),(zPageName));
  form_begin( "id='wh-form'", "%R/wdiff" );
  cgi_printf("  <input id=\"wh-pid\" name=\"pid\" type=\"radio\" hidden>\n"
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    if( strncmp( zAuthor, zUser, sizeof(zAuthor) - 1 ) == 0 ) {
      cgi_printf("<tr class=\"wh-intermediate\" title=\"%s\">\n",(zWhen));
    }
    else {
      strncpy( zAuthor, zUser, sizeof(zAuthor) - 1 );
      cgi_printf("<tr class=\"wh-major\" title=\"%s\">\n",(zWhen));
    }
    /* @ <td data-sortkey="%016llx(iMtime)">%s(zAge)</td> */
    cgi_printf("<td>%s</td>\n",(zAge));
    fossil_free(zAge);
    cgi_printf("<td>%z%S</a></td>\n"
           "<td><input disabled type=\"radio\" name=\"baseline\" value=\"%S\"/></td>\n"
           "<td>%h<span class=\"wh-iterations\" hidden></td>\n",(href("%R/info/%s",zUuid)),(zUuid),(zUuid),(zUser));
    if( showRid ){
      cgi_printf("<td>%z%d</a></td>\n",(href("%R/artifact/%S",zUuid)),(wrid));
    }
    cgi_printf("<td>%zdiff</a></td>\n"
           "</tr>\n",(chref("wh-difflink","%R/wdiff?id=%S",zUuid)));
  }
...
void wdiff_page(void){
  ...
  if( zPid && zPid[0] != 0 ){
    ...
    cgi_printf("<h2>Changes to "
           "\"%z%h</a>\" ",(href("%R/whistory?name=%s",pW1->zWikiTitle)),(pW1->zWikiTitle));
    zDate = db_text(0, "SELECT datetime(%.16g,toLocal())",pW2->rDate);
    cgi_printf("between %z%z</a> ",(href("%R/info/%s",zPid)),(zDate));
    zDate = db_text(0, "SELECT datetime(%.16g,toLocal())",pW1->rDate);
    cgi_printf("and %z%z</a></h2>\n",(href("%R/info/%s",zId)),(zDate));
    style_submenu_element("Previous", "%R/wdiff?id=%S", zPid);
  }else{
    blob_zero(&w2);
    cgi_printf("<h2>Initial version of "
           "\"%z%h</a>\""
           "</h2>\n",(href("%R/whistory?name=%s",pW1->zWikiTitle)),(pW1->zWikiTitle));
  }
...
void wcontent_page(void){
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    if( wrid==0 ){
      if( !showAll ) continue;
      cgi_printf("<tr><td data-sortkey=\"%h\">"
             "%z<s>%h</s></a></td>\n",(zSort),(href("%R/whistory?name=%T",zWName)),(zWDisplayName));
    }else{
      cgi_printf("<tr><td data-sortkey=\"%h\">"
             "%z%h</a></td>\n",(zSort),(href("%R/wiki?name=%T&p",zWName)),(zWDisplayName));
    }
    zAge = human_readable_age(rNow - rWmtime);
    cgi_printf("<td data-sortkey=\"%016llx\">%s</td>\n",(iMtime),(zAge));
    fossil_free(zAge);
    cgi_printf("<td>%z%d</a></td>\n",(href("%R/whistory?name=%T",zWName)),(wcnt));
    if( showRid ){
      cgi_printf("<td>%d</td>\n",(wrid));
    }
    cgi_printf("</tr>\n");
...
static void wiki_section_label(
  ...
  if( (mFlags & WIKIASSOC_FULL_TITLE)==0 ){
    cgi_printf("<div class=\"section accordion\">About</div>\n");
  }else if( zPrefix[0]=='c' ){  /* checkin/... */
    cgi_printf("<div class=\"section accordion\">About check-in %.20h</div>\n",(zName));
  }else{
    cgi_printf("<div class=\"section accordion\">About %s %h</div>\n",(zPrefix),(zName));
  }
}
...
int wiki_render_associated(
  ...
  if( fossil_strcmp(pWiki->zMimetype, "text/x-markdown")==0 ){
    ...
    if( blob_size(&title) ){
      cgi_printf("<div class=\"section accordion\">%h</div>\n",(blob_str(&title)));
    }else{
    ...
    wiki_section_label(zPrefix, zName, mFlags);
    wiki_submenu_to_edit_wiki(zPrefix, zName, mFlags);
    cgi_printf("<div class=\"accordion_panel\"><pre>\n"
           "%h\n"
           "</pre></div>\n",(pWiki->zWiki));
  }else{
    Blob tail = BLOB_INITIALIZER;
    ...
    wiki_submenu_to_edit_wiki(zPrefix, zName, mFlags);
    cgi_printf("<div class=\"accordion_panel\"><div class=\"wiki\">\n");
