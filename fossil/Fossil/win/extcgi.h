...
void vfile_scan(Blob *pPath,int nPrefix,unsigned scanFlags,Glob *pIgnore1,Glob *pIgnore2,int eFType);
...
int popen2(const char *zCmd,int *pfdIn,FILE **ppOut,int *pChildPid,int bDirect);
#include <stdlib.h>
#include <dirent.h>
...
void document_render(Blob *pBody,const char *zMime,const char *zDefaultTitle,const char *zFilename);
