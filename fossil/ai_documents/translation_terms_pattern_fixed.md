...
| >      Definition continues until indentation drops below that of the 2nd line. | > [^标签]: 脚注定义必须从第一列开始。 | Unknown |
| >    document title displayed at the top of the Fossil page. | > 字符 **^** 不是标签的一部分，它是语法的一部分。 | Unknown |
| > "`language-WORD`" is "pikchr". | > 1. 使用制表符或至少四个空格缩进文本 | Unknown |
| > * **\[label\]:&nbsp;URL&nbsp;(Title)** | > * **\[标签\]:&nbsp;URL** | Unknown |
| > 3.  **\[display text\]\(URL 'Title'\)** | > 1.  **\[显示文本\]\(URL\)** | Unknown |
| > > Double-indented paragraph | > > 双重缩进的段落 | Unknown |
| > End a line with two or more spaces to force a mid-paragraph line break. | > 段落之间用空行分隔。 | Unknown |
| > For blocks of text or code: | > 对于文本或代码块： | Unknown |
| > Formatted using [Pikchr](https://pikchr.org/home), resulting in: | > 使用 [Pikchr](https://pikchr.org/home) 进行格式化，结果如下： | Unknown |
| > Labels are case-insensitive. | ## 脚注 ## | Unknown |
| > The first row is a header if followed by a horizontal rule or a blank line. | > 如果第一行后面跟着水平线或空行，则第一行是标题。 | Unknown |
| > This paragraph is indented | > 这个段落被缩进了 | Unknown |
| > body cells are left-aligned. | > 在单元格的左侧、两侧或右侧放置 **:** 分别表示左对齐、居中或右对齐文本。默认情况下，标题和主体单元格都是左对齐的。 | Unknown |
| > but that is purely a presentation matter, controlled by the skin’s CSS. | > 使用标准皮肤，逐字文本以等宽字体呈现，但这纯粹是一个呈现问题，由皮肤的 CSS 控制。 | Unknown |
| > hyperlinks that refer to wiki pages and check-in and ticket hashes. | > 在格式 8 中，URL 成为显示文本。这对于指向 wiki 页面、签入和工单哈希的超链接很有用。 | Unknown |
| > may be split onto the next line with optional indenting. | > 对于链接格式 5、6 和 7（"引用链接"），URL 在文档的其他地方提供，如下所示。链接格式 6 和 7 重用显示文本作为标签。标签不区分大小写。标题可以分割到下一行，并可选择缩进。 | Unknown |
| > respectively, contains at least one blank cell. | > 最左侧或最右侧的 **\|** 仅在第一列或最后一列（分别）包含至少一个空单元格时才需要。 | Unknown |
| >Artifact(s)<br>\n | >制品<br>\n | Unknown |
| >\n | ></p>\n | Unknown |
| @     <li>%z(href("%R/pikchrshow"))Pikchr Sandbox</a></li> | @     <li>%z(href("%R/wcontent"))维基页面列表</a></li> | Unknown |
| @     <li>%z(href("%R/wikisrch"))Wiki Search</a></li> | @     <li>%z(href("%R/wikisrch"))维基搜索</a></li> | Unknown |
| @   <li>%z(href("%R/attachlist"))List of Attachments</a></li> | @   <li>%z(href("%R/timeline?y=t"))近期活动</a></li> | Unknown |
| @   <li>%z(href("%R/bloblist"))List of Artifacts</a></li> | @   <li>%z(href("%R/bloblist"))制品列表</a></li> | Unknown |
| @   <li>%z(href("%R/fileedit"))On-line File Editor</li> | @   <li>%z(href("%R/fileedit"))在线文件编辑器</li> | Unknown |
| @   <li>%z(href("%R/hash-collisions"))Collisions on hash prefixes</a></li> | @   <li>%z(href("%R/hash-collisions"))哈希前缀冲突</a></li> | Unknown |
| @   <li>%z(href("%R/leaves"))Leaf Check-ins</a></li> | @   <li>%z(href("%R/taglist"))标签</a></li> | Unknown |
| @   <li>%z(href("%R/md_rules"))Markdown Formatting Rules</a></li> | @   <li>%z(href("%R/wiki_rules"))维基格式规则</a></li> | Unknown |
| @   <li>%z(href("%R/sitemap-timeline"))Other timelines</a></li> | @   <li>%z(href("%R/reports"))活动报告</a></li> | Unknown |
| @   <li>%z(href("%R/test-all-help"))All "help" text on a single page</a></li> | @   <li>%z(href("%R/test-all-help"))所有帮助文本（单页显示）</a></li> | Unknown |
| @   <li>%z(href("%R/timeline?y=f"))Recent activity</a></li> | @   <li>%z(href("%R/timeline?y=f"))近期活动</a></li> | Unknown |
| @   <li>%z(href("%R/tktsrch"))Ticket Search</a></li> | @   <li>%z(href("%R/tktsrch"))工单搜索</a></li> | Unknown |
| @   <li>%z(href("%R/urllist"))访问此仓库的URL列表</a></li> | @       this repository</a></li> | Unknown |
| @   <li>%z(href("%R/uvlist"))Unversioned Files</a> | @   <li>%z(href("%R/tree?type=tree&ci=trunk"))树状视图, | Unknown |
| @   <li><a href="%R/modreq">Pending Moderation Requests</a></li> | @   <li><a href="%R/secaudit0">安全审计</a></li> | Unknown |
| @ (Property: "email-listid")</p> | @ 如果此值不为空字符串，则它将成为所有出站通知电子邮件中"List-ID:"头的参数。 | Unknown |
| @ (Property: "email-renew-interval")</p> | @ 如果此值是大于或等于14的整数N，则电子邮件通知订阅 | Unknown |
| @ (Property: "localauth") | @ (属性: "localauth") | Unknown |
| @ (Property: robot-restrict) | @ 要禁用机器人限制，请将此设置更改为"off"。 | Unknown |
| @ <a href="%R/search">/search</a> webpage. | @ 影响<a href="%R/search">/search</a>网页的服务器特定设置。 | Unknown |
| @ <b>Warning:</b> Not all artifacts | @ <b>警告：</b> 并非所有制品 | Unknown |
| @ <div>管理日志功能处于%s(fLogEnabled?"开启":"关闭")状态。 | @ (Change this on the <a href="setup_settings">settings</a> page.)</div> | Unknown |
| @ <label for='cbResetMenu'>Reset menu to default value</label> | @ <label for='cbResetMenu'>将菜单重置为默认值</label> | Unknown |
| @ <li> <b>ticket/</b><i>full-ticket-hash</i> | @ <li> <b>branch/</b><i>分支名称</i> | Unknown |
| @ <li> Hash-path: <i>NULL</i> | @ <li> 哈希路径: <i>空</i> | Unknown |
| @ <li> Hash-path: <tt>%h(z)</tt> | @ <li> 哈希路径: <tt>%h(z)</tt> | Unknown |
| @ <li> Wiki-path: <i>NULL</i> | @ <li> Wiki 路径: <i>空</i> | Unknown |
| @ <li> Wiki-path: <tt>%h(z)</tt> | @ <li> Wiki 路径: <tt>%h(z)</tt> | Unknown |
| @ <li> 此按钮被勾选 | @ in the CGI script. | Unknown |
| @ <li> 第一个项是/sitemap条目的显示名称 | @      the entry is omitted.  "*" is always true. | Unknown |
| @ <li> 第一个项是显示在菜单上的文本。 | @      very wide, respectively. | Unknown |
| @ <li>%z(href("%R/alerts"))Email Alerts for %h(g.zLogin)</a></li> | @ <li>%z(href("%R/alerts"))邮件提醒 %h(g.zLogin)</a></li> | Unknown |
| @ <li>%z(href("%R/brlist"))Branches</a> | @ <li>%z(href("%R/brlist"))分支</a> | Unknown |
| @ <li>%z(href("%R/chat"))Chat</a></li> | @ <li>%z(href("%R/chat"))聊天</a></li> | Unknown |
| @ <li>%z(href("%R/ckout"))Checkout Status</a></li> | @ <li>%z(href("%R/ckout"))检出状态</a></li> | Unknown |
| @ <li>%z(href("%R/cookies"))Cookies</a></li> | @ <li>%z(href("%R/cookies"))Cookie设置</a></li> | Unknown |
| @ <li>%z(href("%R/help"))Help</a> | @ <li>%z(href("%R/help"))帮助</a> | Unknown |
| @ <li>%z(href("%R/home"))Home Page</a> | @ <li>%z(href("%R/home"))首页</a> | Unknown |
| @ <li>%z(href("%R/login"))Login</a> | @ <li>%z(href("%R/login"))登录</a> | Unknown |
| @ <li>%z(href("%R/logout"))Change Password for %h(g.zLogin)</a></li> | @ <li>%z(href("%R/logout"))修改密码 %h(g.zLogin)</a></li> | Unknown |
| @ <li>%z(href("%R/logout"))Logout from %h(g.zLogin)</a> | @ <li>%z(href("%R/logout"))退出登录 %h(g.zLogin)</a> | Unknown |
| @ <li>%z(href("%R/register"))Create a new account</a></li> | @ <li>%z(href("%R/register"))创建新账户</a></li> | Unknown |
| @ <li>%z(href("%R/repo_schema"))Repository schema</a></li> | @ <li>%z(href("%R/test-backlinks"))反向链接列表</a></li> | Unknown |
| @ <li>%z(href("%R/reportlist"))Tickets/Bug Reports</a> | @ <li>%z(href("%R/reportlist"))工单/缺陷报告</a> | Unknown |
| @ <li>%z(href("%R/search"))Search</a></li> | @ <li>%z(href("%R/search"))搜索</a></li> | Unknown |
| @ <li>%z(href("%R/sitemap"))Site Map</a></li> | @ <li>%z(href("%R/sitemap"))站点地图</a></li> | Unknown |
| @ <li>%z(href("%R/sitemap-test"))Test Pages</a></li> | @ <li>%z(href("%R/skins"))皮肤</a></li> | Unknown |
| @ <li>%z(href("%R/stat"))Repository Status</a> | @ <li>%z(href("%R/stat"))仓库状态</a> | Unknown |
| @ <li>%z(href("%R/subscribe"))Subscribe to Email Alerts</a></li> | @ <li>%z(href("%R/subscribe"))订阅邮件提醒</a></li> | Unknown |
| @ <li>%z(href("%R/test-bgcolor"))Background color test</a> | @ <li>%z(href("%R/test-builtin-files"))内置文件列表</a></li> | Unknown |
| @ <li>%z(href("%R/test-env"))CGI Environment Test</a></li> | @ <li>%z(href("%R/test-env"))CGI环境测试</a></li> | Unknown |
| @ <li>%z(href("%R/test-piechart"))Pie-Chart generator test</a></li> | @ <li>%z(href("%R/cookies"))显示首选项Cookie内容</a></li> | Unknown |
| @ <li>%z(href("%R/test-rename-list"))List of file renames</a></li> | @ <li>%z(href("%R/test-rename-list"))文件重命名列表</a></li> | Unknown |
| @ <li>%z(href("%R/timeline"))Project Timeline</a> | @ <li>%z(href("%R/timeline"))项目时间线</a> | Unknown |
| @ <li>%z(href("%R/timeline?deltabg"))Delta vs. baseline manifests</a></li> | @ <li>%z(href("%R/timeline?ymd"))当天</a></li> | Unknown |
| @ <li>%z(href("%R/timewarps"))Timeline of timewarps</a></li> | @ <li>%z(href("%R/timewarps"))时间扭曲时间线</a></li> | Unknown |
| @ <li>%z(href("%R/tree"))File Browser</a> | @ <li>%z(href("%R/tree"))文件浏览器</a> | Unknown |
| @ <li>%z(href("%R/wikihelp"))Wiki</a> | @ <li>%z(href("%R/wikihelp"))维基</a> | Unknown |
| @ <li><a href="%R/setup">Administration Pages</a> | @ <li><a href="%R/setup">管理页面</a> | Unknown |
| @ <li>Suggested <a href="setup_skinedit?w=0">CSS</a> changes: | @ <b>广告单元说明：</b><ul> | Unknown |
| @ <li>如需测试用的占位广告单元，请复制粘贴以下内容，并适当调整"width:"和"height:"。 | @ with appropriate adjustments to "width:" and "height:". | Unknown |
| @ <p>(Properties: "background-image" and "background-mimetype") | @ <p>（属性："background-image" 和 "background-mimetype"） | Unknown |
| @ <p>(Properties: "icon-image" and "icon-mimetype") | @ <p>（属性："icon-image" 和 "icon-mimetype"） | Unknown |
| @ <p>(Properties: "logo-image" and "logo-mimetype") | @ <input type="submit" name="setlogo" value="更改Logo"> | Unknown |
| @ <p><a href="admin_log?n=%d(limit)&x=%d(limit+ofst)">[Older]</a></p> | @ <p><a href="admin_log?n=%d(limit)&x=%d(limit+ofst)">[较旧]</a></p> | Unknown |
| @ <p><a href="admin_log?n=%d(limit)&x=%d(prevx)">[Newer]</a></p> | @ <p><a href="admin_log?n=%d(limit)&x=%d(prevx)">[较新]</a></p> | Unknown |
| @ <p><b>必填项。</b> | @ (Property: "email-url")</p> | Unknown |
| @ <p><b>必填项。</b> | @ can handle bounces. (Property: "email-self")</p> | Unknown |
| @ <p><b>必填项。</b> | @ (Property: "email-subname")</p> | Unknown |
| @ <p><input type="submit" name="fts0" value="删除全文索引"> | style_submenu_element("FTS Index Debugging","%R/test-ftsdocs"); | Unknown |
| @ <p>The main menu for the web interface | @ <p>Web界面的主菜单 | Unknown |
| @ <p>一些自定义皮肤可能不使用此属性。是否使用此属性是由皮肤设计师做出的选择。 | @ on this list. (Property: mainmenu) | Unknown |
| @ <p>一组逗号分隔的glob模式，指定无需登录即可访问的页面，使用下方 | @ "Default privileges" setting below. | Unknown |
| @ <p>使用示例：将此字段设置为"/doc/trunk/www/*"，并将 | @ (Property: "public-pages") | Unknown |
| @ <p>允许在<a href="%R/md_rules">Markdown格式</a>文档中生成"不安全"HTML（例如：&lt;script&gt;、&lt;form&gt;等）。 | @ document in which to allow unsafe HTML: | Unknown |
| @ <p>出现在<a href="%R/sitemap">/sitemap</a>页面上的额外链接， | @ will appear on the hamburger menu. | Unknown |
| @ <p>匿名登录Cookie的有效分钟数。 | @ (property: anon-cookie-lifespan) | Unknown |
| @ <p>即使是一个适度的项目，Fossil网站的树结构中也可能有数以十亿计的页面。其中许多页面（例如：差异比较和压缩包） | @ website can present a crippling CPU and bandwidth load. | Unknown |
| @ <p>启用后，Web访问始终需要密码登录。禁用时，当使用 | @ of the following are true: | Unknown |
| @ <p>启用后，任何Wiki变更都需要Wiki审核员的批准 | @ moderation. (Property: "modreq-wiki") | Unknown |
| @ <p>启用后，任何工单变更都需要工单审核员的批准 | @ moderation. (Property: "modreq-tkt") | Unknown |
| @ <p>启用后，允许使用HTTP_AUTHENTICATION环境变量或"Authentication:" HTTP头来查找用户名和 | @ (Property: "http_authentication_ok") | Unknown |
| @ <p>启用后，匿名用户的登录屏幕上会出现一个按钮，可自动填写验证码密码。 | @ anonymous users.  (Property: "auto-captcha")</p> | Unknown |
| @ <p>启用后，如果REMOTE_USER环境变量设置为有效用户的登录名，且没有其他登录凭据可用， | @ (Property: "remote_user_ok") | Unknown |
| @ <p>在时间线显示中，签入评论仅显示到 | @ in Git repositories (Property: "timeline-truncate-at-blank")</p> | Unknown |
| @ <p>在没有用户显示偏好 cookie 设置或显式 n= 查询参数的情况下，时间线上显示的最大行数。 | @ parameter.  (Property: "timeline-default-length")</p> | Unknown |
| @ <p>如何发送电子邮件。需要以下字段提供辅助信息。 | @ (Property: "email-send-method")</p> | Unknown |
| @ <p>如果此设置不为空字符串，则时间线上出现的任何更改都会在聊天室中以提供的用户名进行公告。 | @ (Property: "chat-timeline-user")</p> | Unknown |
| @ <p>如果选择了 "HH:MM" 或 "HH:MM:SS" 格式，那么每当日期更改时，日期将显示在单独的框中 | @ CSS class "timelineTime". (Property: "timeline-date-format")</p> | Unknown |
| @ <p>对于未登录用户的编辑操作（追加、创建或编辑wiki或工单，或向wiki或工单添加附件）需要验证码。 | @ for users who are not logged in. (Property: "require-captcha")</p> | Unknown |
| @ <p>当传入URL的第一个部分与上方左侧(LHS)的"别名"完全匹配时，URL将转换为右侧(RHS)的相应形式。 | @ converted into the corresponding form on the right-hand side (RHS). | Unknown |
| @ <p>当前使用SQLite FTS%d(search_index_type(0))搜索索引。 | @ or %.1f(100.0*(double)nFts/(double)nTotal)%% of the repository.</p> | Unknown |
| @ <p>当发送方法为"SMTP中继"时，每条电子邮件消息通过SMTP协议（rfc5321） | @ (Property: "email-send-relayhost")</p> | Unknown |
| @ <p>当发送方法为"存储在目录中"时，每条电子邮件消息作为单独的文件存储在此处显示的目录中。 | @ (Property: "email-send-dir")</p> | Unknown |
| @ <p>所有用户都可以通过以下URL访问Logo： | @ To change the logo image, use the following form:</p> | Unknown |
| @ <p>所有用户都可以通过以下URL访问图标图像： | @ To change the icon image, use the following form:</p> | Unknown |
| @ <p>所有用户都可以通过以下URL访问背景图像： | @ To change the background image, use the following form:</p> | Unknown |
| @ <p>授予以下用户的权限：<ul><li>使用自行注册程序注册的用户（如果启用），或<li>访问由上述public-pages glob模式标识的"公开" | @ (Property: "default-perms") | Unknown |
| @ <p>描述您的项目。这将用于搜索引擎的页面标题、 | @ (Property: "project-description")</p> | Unknown |
| @ <p>显示 UTC 时间（有时也称为格林威治标准时间 (GMT) 或 | @ Zulu) instead of in local time.  On this server, local time is currently | Unknown |
| @ <p>本页面的设置旨在帮助站点管理员保护站点免受机器人的影响。 | @ defend the site against robots. | Unknown |
| @ <p>此设置应为TCL列表。每组连续的四个值定义一个主菜单项： | @ values defines a single main menu item: | Unknown |
| @ <p>此设置应为分为三元组的TCL列表。每个三元组定义一个新条目： | @ triple defines a new entry: | Unknown |
| @ <p>点击下方的重建按钮来重建仓库。新被回避的制品 | @ two, so be patient after pressing the button.</p> | Unknown |
...
| cgi_printf("<p>当前使用SQLite FTS%d搜索索引。\n" | "or %.1f%% of the repository.</p>\n",(search_index_type(0)),(zSize),(100.0*(double)nFts/(double)nTotal)); | Unknown |
...
| entry_attribute("Administrator email address", 40, "email-admin", | entry_attribute("管理员电子邮件地址", 40, "email-admin", | Unknown |
| entry_attribute("Allow Unsafe HTML In Markdown", 6, | entry_attribute("允许在Markdown中使用不安全HTML", 6, | Unknown |
| entry_attribute("Anonymous Login Validity", 11, "anon-cookie-lifespan", | entry_attribute("匿名登录有效期", 11, "anon-cookie-lifespan", | Unknown |
| entry_attribute("Authorized subscription email addresses", 35, | entry_attribute("授权的订阅电子邮件地址", 35, | Unknown |
| entry_attribute("Canonical Server URL", 40, "email-url", | entry_attribute("规范服务器URL", 40, "email-url", | Unknown |
| entry_attribute("Chat Polling Timeout", 10, | entry_attribute("聊天轮询超时时间", 10, | Unknown |
| entry_attribute("Chat Timeline Robot Username", 15, | @ <p>新的聊天内容使用"长轮询"技术下载。系统向/chat-poll发送HTTP请求，该请求会阻塞等待新内容到达。 | Unknown |
| entry_attribute("Default Number Of Rows", 6, "timeline-default-length", | entry_attribute("默认行数", 6, "timeline-default-length", | Unknown |
| entry_attribute("Default privileges", 10, "default-perms", | entry_attribute("默认权限", 10, "default-perms", | Unknown |
...
| multiple_choice_attribute("Per-Item Time Format", "timeline-date-format", | multiple_choice_attribute("每项时间格式", "timeline-date-format", | Unknown |
