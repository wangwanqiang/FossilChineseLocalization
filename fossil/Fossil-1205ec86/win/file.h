...
void file_rmdir_sql_function(sqlite3_context *context,int argc,sqlite3_value **argv);
int file_rmdir(const char *zName);
#if defined(_WIN32)
void test_is_normal_dir(void);
int file_is_normal_dir(wchar_t *zName);
#endif
void file_delete_sql_function(sqlite3_context *context,int argc,sqlite3_value **argv);
...
int file_rename(const char *zFrom,const char *zTo,int isFromDir,int isToDir);
void file_dirname_sql_function(sqlite3_context *context,int argc,sqlite3_value **argv);
