#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\info.c"
/*
  ...
  if( !g.perm.Hyperlink ){
    ...
    if( zOld && zNew ){
      if( fossil_strcmp(zOld, zNew)!=0 ){
        if( zOldName!=0 && fossil_strcmp(zName,zOldName)!=0 ){
          cgi_printf("Renamed and modified\n"
                 ...
                 "to %z"
                 "%h</a>\n"
                 "%z[%S]</a>.\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zOldName,zOld,zCkin)),(zOldName),(href("%R/artifact/%!S",zOld)),(zOld),(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zNew,zCkin)),(zName),(href("%R/artifact/%!S",zNew)),(zNew));
        }else{
          cgi_printf("Modified %z"
                 "%h</a>\n"
                 "from %z[%S]</a>\n"
                 "to %z[%S]</a>.\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zNew,zCkin)),(zName),(href("%R/artifact/%!S",zOld)),(zOld),(href("%R/artifact/%!S",zNew)),(zNew));
        }
      }else if( zOldName!=0 && fossil_strcmp(zName,zOldName)!=0 ){
        cgi_printf("Name change\n"
               ...
               "%h</a>\n"
               "to %z"
               "%h</a>.\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zOldName,zOld,zCkin)),(zOldName),(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zNew,zCkin)),(zName));
      }else{
        cgi_printf("%z"
               "%h</a> became\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zNew,zCkin)),(zName));
        if( mperm==PERM_EXE ){
      ...
      cgi_printf("Deleted %z"
             "%h</a> version %z[%S]</a>.\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zOld,zCkin)),(zName),(href("%R/artifact/%!S",zOld)),(zOld));
    }else{
      cgi_printf("Added %z"
             "%h</a> version %z[%S]</a>.\n",(href("%R/finfo?name=%T&m=%!S&ci=%!S",zName,zNew,zCkin)),(zName),(href("%R/artifact/%!S",zNew)),(zNew));
    }
...
void ci_page(void){
  ...
  cgi_printf("</div><div class=\"section accordion\">Changes</div>\n"
         "<div class=\"accordion_panel\">\n"
...
void hexdump_page(void){
  ...
  if( !g.isHuman ){
    ...
    ** no good reason for a robot to need a hexdump. */
    cgi_printf("<p>A hex dump of this file is not available.\n"
