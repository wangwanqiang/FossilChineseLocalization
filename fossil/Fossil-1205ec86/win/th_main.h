...
int capexprCmd(Th_Interp *interp,void *p,int argc,const char **argv,int *argl);
...
int Th_ReportTaint(Th_Interp *interp,const char *zWhere,const char *zStr,int nStr);
