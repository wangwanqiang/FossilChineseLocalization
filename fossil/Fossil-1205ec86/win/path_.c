#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\path.c"
/*
...
void test_rename_list_page(void){
  ...
  cgi_printf("<h1>%d filename changes in %d check-ins</h1>\n"
  ...
  while( db_step(&q)==SQLITE_ROW ){
    ...
    cgi_printf("<tr>\n"
           ...
           "<td>%z%h</a></td>\n"
           "<td>%z%h</a></td>\n"
           "<td>%z%S</a></td></tr>\n",(href("%R/timeline?c=%t",zDate)),(zDate),(href("%R/finfo?name=%t",zOld)),(zOld),(href("%R/finfo?name=%t",zNew)),(zNew),(href("%R/info/%!S",zUuid)),(zUuid));
  }
