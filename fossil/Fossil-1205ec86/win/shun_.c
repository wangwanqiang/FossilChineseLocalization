#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\shun.c"
/*
...
void shun_page(void){
  ...
  if( zUuid && reviewList ){
    ...
    int nTotal = 0;
    int nOk = 0;
    cgi_printf("<table class=\"shun-review\"><tbody><tr><td>\n");
    for( p = zUuid ; *p ; p += strlen(p)+1 ){
  ...
  cgi_printf("<textarea class=\"fullsize-text\" cols=\"70\" rows=\"%d\" name=\"uuid\">\n",(numRows));
  if( zShun ){
    if( strlen(zShun) ){
      cgi_printf("%h\n",(zShun));
    }else if( nRcvid ){
