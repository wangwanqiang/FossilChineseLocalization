#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\user.c"
/*
...
void user_log_page(void){
  ...
  cgi_printf("<div align=\"center\">User logging is %s.\n"
  ...
  while( rc==SQLITE_OK && db_step(&q)==SQLITE_ROW ){
    ...
    if( bSuccess ){
      ...
      cgi_printf("<tr bgcolor=\"#ffacc0\">\n");
    }
    cgi_printf("<td>%s</td><td>%h</td><td>%h</td></tr>\n",(zDate),(zName),(zIP));
  }
  if( skip>0 || cnt>n ){
