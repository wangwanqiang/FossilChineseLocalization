#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\login.c"
/*
...
void login_page(void){
  ...
  if( zGoto && !noAnon ){
    ...
    if( g.zLogin ){
      ...
      cgi_printf("<p>Login as <b>anonymous</b> or any named user\n"
             "to access page <b>%h</b>.\n",(zAbbrev));
    }else{
  ...
  if( g.zLogin ){
    ...
    cgi_printf("<tr>\n"
           ...
           "size=\"30\" value=\"%s\" autofocus></td>\n"
           "</tr>\n"
           "<tr>\n"
           " <td class=\"form_label\" id=\"pswdlabel\">Password:</td>\n"
           " <td><input aria-labelledby=\"pswdlabel\" type=\"password\" id=\"p\" "
           "name=\"p\" value=\"\" size=\"30\">",(anonFlag?"anonymous":""));
    if( zAnonPw && !noAnon ){
