#line 1 "C:\\source\\fossil_depot\\fossil\\Fossil-1205ec86\\src\\loadctrl.c"
/*
...
void overload_page(void){
  ...
  cgi_printf("<h2>The server load is currently too high.\n"
         "Please try again later.</h2>\n"
         "<p>Current load average: %f<br>\n"
         "Load average limit: %f<br>\n"
         "URL: %h%h<br>\n"
         "Timestamp: %hZ</p>\n",(load_average()),(mxLoad),(g.zBaseURL),(P("PATH_INFO")),(db_text("","SELECT datetime()")));
  style_finish_page();
}
