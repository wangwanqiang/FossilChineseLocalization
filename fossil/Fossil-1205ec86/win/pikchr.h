...
void pik_parser(void *yyp,int yymajor,pik_parserTOKENTYPE yyminor pik_parserARG_PDECL);
...
#endif
#if !defined(pik_parser_ENGINEALWAYSONSTACK)
void pik_parserFree(void *p,void(*freeProc)(void *));
#endif
